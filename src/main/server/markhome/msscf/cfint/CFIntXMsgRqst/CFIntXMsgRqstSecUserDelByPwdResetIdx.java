 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserDelByPwdResetIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserDelByPwdResetIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserDelByPwdResetIdx" );
