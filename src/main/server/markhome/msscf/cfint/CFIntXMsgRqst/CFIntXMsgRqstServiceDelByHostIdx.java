 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelByHostIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelByHostIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceDelByHostIdx" );
