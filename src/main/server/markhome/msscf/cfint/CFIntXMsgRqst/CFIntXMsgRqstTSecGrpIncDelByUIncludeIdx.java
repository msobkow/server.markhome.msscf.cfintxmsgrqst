 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncDelByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncDelByUIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncDelByUIncludeIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpIncTableObj().deleteTSecGrpIncByUIncludeIdx( natTenantId,
				natTSecGroupId,
				natIncludeGroupId );
