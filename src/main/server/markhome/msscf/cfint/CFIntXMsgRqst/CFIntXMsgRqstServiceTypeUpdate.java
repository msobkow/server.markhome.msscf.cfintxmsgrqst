...
/*
 *	CFIntXMsgRqstServiceTypeUpdate XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntServiceTypeObj origBuff = ((ICFIntServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceType( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntServiceTypeEditObj editBuff = (ICFIntServiceTypeEditObj)origBuff.beginEdit();
				CFSecServiceTypeBuff dataBuff = editBuff.getServiceTypeBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnUpdated( "\n\t\t\t", origBuff.getServiceTypeBuff() )
					+	"\n"
