 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncDelByIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncDelByIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncDelByIncludeIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpIncTableObj().deleteTSecGrpIncByIncludeIdx( natTenantId,
				natIncludeGroupId );
