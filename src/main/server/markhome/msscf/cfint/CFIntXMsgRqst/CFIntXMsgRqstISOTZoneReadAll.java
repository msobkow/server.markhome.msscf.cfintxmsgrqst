...
/*
 *	CFIntXMsgRqstISOTZoneReadAll XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
