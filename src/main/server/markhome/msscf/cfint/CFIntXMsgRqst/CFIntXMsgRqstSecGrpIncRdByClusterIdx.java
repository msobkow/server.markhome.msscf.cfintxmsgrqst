 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpIncObj> list = schemaObj.getSecGrpIncTableObj().readSecGrpIncByClusterIdx( natClusterId );
