 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserRdByPwdResetIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserRdByPwdResetIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserRdByPwdResetIdx" );
			...
			// Read the objects
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().readSecUserByPwdResetIdx( natPasswordResetUuid );
