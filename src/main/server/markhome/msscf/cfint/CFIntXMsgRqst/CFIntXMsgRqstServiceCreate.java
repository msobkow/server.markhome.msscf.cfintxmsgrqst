...
/*
 *	CFIntXMsgRqstServiceCreate XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecServiceBuff dataBuff = (CFSecServiceBuff)editBuff.getServiceBuff();
			// Extract Attributes
			...
			ICFIntServiceObj created = (ICFIntServiceObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnCreated( "\n\t\t\t", created.getServiceBuff() )
				+	"\n"
