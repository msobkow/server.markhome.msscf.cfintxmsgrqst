 ...
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupRdByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupRdByUNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupRdByUNameIdx" );
			...
			// Read the object
			ICFIntSecGroupObj read = ((ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroupByUNameIdx( natClusterId,
				natName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnSingleOpenTag()
					+	CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnDerivedRec( "\n\t\t", read.getSecGroupBuff() ) + "\n"
					+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnSingleCloseTag()
