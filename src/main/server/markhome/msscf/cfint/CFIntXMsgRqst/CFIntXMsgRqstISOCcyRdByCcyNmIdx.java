 ...
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyRdByCcyNmIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyRdByCcyNmIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyRdByCcyNmIdx" );
			...
			// Read the object
			ICFIntISOCcyObj read = ((ICFIntISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcyByCcyNmIdx( natName,
				true ));
			if( read != null ) {
