...
/*
 *	CFIntXMsgRqstSecFormRdBy XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecFormObj> list = schemaObj.getSecFormTableObj().readSecFormByClusterIdx( natClusterId );
