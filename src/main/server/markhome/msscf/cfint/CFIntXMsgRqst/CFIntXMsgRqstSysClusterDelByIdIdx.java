 ...
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSysClusterDelByIdIdx" );
