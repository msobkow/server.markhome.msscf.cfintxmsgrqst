...
/*
 *	CFIntXMsgRqstTopProjectCreate XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRqstTopProjectCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopProjectCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntTopProjectBuff dataBuff = (CFIntTopProjectBuff)editBuff.getTopProjectBuff();
			// Extract Attributes
			...
			ICFIntTopProjectObj created = (ICFIntTopProjectObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTopProjectMessageFormatter.formatTopProjectRspnCreated( "\n\t\t\t", created.getTopProjectBuff() )
				+	"\n"
