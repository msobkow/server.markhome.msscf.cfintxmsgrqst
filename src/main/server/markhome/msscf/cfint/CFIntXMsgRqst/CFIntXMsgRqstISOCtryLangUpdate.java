...
/*
 *	CFIntXMsgRqstISOCtryLangUpdate XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntISOCtryLangObj origBuff = ((ICFIntISOCtryLangObj)schemaObj.getISOCtryLangTableObj().readISOCtryLang( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntISOCtryLangEditObj editBuff = (ICFIntISOCtryLangEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnUpdated( "\n\t\t\t", origBuff.getISOCtryLangBuff() )
					+	"\n"
