...
/*
 *	CFIntXMsgRqstSecUserUpdate XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntSecUserObj origBuff = ((ICFIntSecUserObj)schemaObj.getSecUserTableObj().readSecUser( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntSecUserEditObj editBuff = (ICFIntSecUserEditObj)origBuff.beginEdit();
				CFSecSecUserBuff dataBuff = editBuff.getSecUserBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecUserMessageFormatter.formatSecUserRspnUpdated( "\n\t\t\t", origBuff.getSecUserBuff() )
					+	"\n"
