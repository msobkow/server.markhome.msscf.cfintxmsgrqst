...
/*
 *	CFIntXMsgRqstTldDelete XML SAX Element  implementation
 *	for Tld.
 */
public class CFIntXMsgRqstTldDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTldDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntTldObj read = ((ICFIntTldObj)schemaObj.getTldTableObj().readTld( pkey ));
			if( read != null ) {
				if( read.getTldBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntTldEditObj editBuff = (ICFIntTldEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgTldMessageFormatter.formatTldRspnDeleted() +	"\n"
