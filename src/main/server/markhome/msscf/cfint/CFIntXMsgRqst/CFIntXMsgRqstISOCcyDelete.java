...
/*
 *	CFIntXMsgRqstISOCcyDelete XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyDelete" );
			...
			// Delete the object
			ICFIntISOCcyObj read = ((ICFIntISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcy( pkey ));
			if( read != null ) {
				if( read.getISOCcyBuff().getRequiredRevision() > natRevision ) {
					throw new CFLibCollisionDetectedException( getClass(),
						S_ProcName,
						"Collision detected preparing to delete ISOCcy" );
				}
				else {
					ICFIntISOCcyEditObj editBuff = (ICFIntISOCcyEditObj)read.beginEdit();
					if( editBuff != null ) {
