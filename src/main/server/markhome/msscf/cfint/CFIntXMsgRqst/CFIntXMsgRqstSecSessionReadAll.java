...
// Description: Java 11 XML Message SAX Request Read All Element  for SecSession
...
/*
 *	CFIntXMsgRqstSecSessionReadAll XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().readAllSecSession( true );
