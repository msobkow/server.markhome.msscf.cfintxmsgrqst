 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceRdByHostIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceRdByHostIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceRdByHostIdx" );
			...
			// Read the objects
			List<ICFSecServiceObj> list = schemaObj.getServiceTableObj().readServiceByHostIdx( natClusterId,
				natHostNodeId );
