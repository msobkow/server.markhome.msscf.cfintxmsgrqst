...
/*
 *	CFIntXMsgRqstSecSessionRdBy XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRdByStartIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRdByStartIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionRdByStartIdx" );
			...
			// Read the object
			ICFIntSecSessionObj read = ((ICFIntSecSessionObj)schemaObj.getSecSessionTableObj().readSecSessionByStartIdx( natSecUserId,
				natStart,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecSessionMessageFormatter.formatSecSessionRspnSingleOpenTag()
					+	CFIntXMsgSecSessionMessageFormatter.formatSecSessionRspnDerivedRec( "\n\t\t", read.getSecSessionBuff() ) + "\n"
					+	"\t" + CFIntXMsgSecSessionMessageFormatter.formatSecSessionRspnSingleCloseTag()
