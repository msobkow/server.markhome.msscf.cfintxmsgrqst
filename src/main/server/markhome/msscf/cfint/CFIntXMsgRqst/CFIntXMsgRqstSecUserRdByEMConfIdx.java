 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserRdByEMConfIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserRdByEMConfIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserRdByEMConfIdx" );
			...
			// Read the objects
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().readSecUserByEMConfIdx( natEMailConfirmUuid );
