 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembDelByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembDelByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembDelByUserIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpMembTableObj().deleteSecGrpMembByUserIdx( natSecUserId );
