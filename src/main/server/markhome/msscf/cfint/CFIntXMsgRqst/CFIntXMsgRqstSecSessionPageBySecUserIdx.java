 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionPageBySecUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionPageBySecUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionPageBySecUserIdx" );
			...
			// Page the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().pageSecSessionBySecUserIdx( natSecUserId,
