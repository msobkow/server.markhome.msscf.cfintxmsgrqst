...
/*
 *	CFIntXMsgRqstTenantUpdate XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntTenantObj origBuff = ((ICFIntTenantObj)schemaObj.getTenantTableObj().readTenant( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntTenantEditObj editBuff = (ICFIntTenantEditObj)origBuff.beginEdit();
				CFSecTenantBuff dataBuff = editBuff.getTenantBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTenantMessageFormatter.formatTenantRspnUpdated( "\n\t\t\t", origBuff.getTenantBuff() )
					+	"\n"
