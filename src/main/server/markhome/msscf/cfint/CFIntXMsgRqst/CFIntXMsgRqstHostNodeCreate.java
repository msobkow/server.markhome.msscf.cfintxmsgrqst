...
/*
 *	CFIntXMsgRqstHostNodeCreate XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecHostNodeBuff dataBuff = (CFSecHostNodeBuff)editBuff.getHostNodeBuff();
			// Extract Attributes
			...
			ICFIntHostNodeObj created = (ICFIntHostNodeObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgHostNodeMessageFormatter.formatHostNodeRspnCreated( "\n\t\t\t", created.getHostNodeBuff() )
				+	"\n"
