 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembDelByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembDelByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembDelByUserIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpMembTableObj().deleteTSecGrpMembByUserIdx( natSecUserId );
