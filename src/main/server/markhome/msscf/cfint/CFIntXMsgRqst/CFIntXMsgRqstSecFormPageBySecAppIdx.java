 ...
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormPageBySecAppIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormPageBySecAppIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormPageBySecAppIdx" );
			...
			// Page the objects
			List<ICFSecSecFormObj> list = schemaObj.getSecFormTableObj().pageSecFormBySecAppIdx( natClusterId,
				natSecAppId,
				natPriorClusterId,
				natPriorSecFormId );
