...
/*
 *	CFIntXMsgRqstTldLock XML SAX Element  implementation
 *	for Tld.
 */
public class CFIntXMsgRqstTldLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTldLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntTldObj locked = ((ICFIntTldObj)schemaObj.getTldTableObj().lockTld( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTldMessageFormatter.formatTldRspnLocked( "\n\t\t\t", locked.getTldBuff() )
				+	"\n"
