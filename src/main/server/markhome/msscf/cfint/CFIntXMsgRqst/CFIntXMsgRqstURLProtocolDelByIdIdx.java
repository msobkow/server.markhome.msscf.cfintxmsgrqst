 ...
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstURLProtocolDelByIdIdx" );
