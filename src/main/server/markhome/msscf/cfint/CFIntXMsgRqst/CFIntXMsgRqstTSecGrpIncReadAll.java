...
// Description: Java 11 XML Message SAX Request Read All Element  for TSecGrpInc
...
/*
 *	CFIntXMsgRqstTSecGrpIncReadAll XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncReadAll" );
			...
			List<ICFSecTSecGrpIncObj> list = schemaObj.getTSecGrpIncTableObj().readAllTSecGrpInc( true );
