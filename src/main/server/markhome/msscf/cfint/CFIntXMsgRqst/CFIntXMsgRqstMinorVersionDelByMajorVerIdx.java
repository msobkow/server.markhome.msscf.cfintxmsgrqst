...
/*
 *	CFIntXMsgRqstMinorVersionDelBy XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionDelByMajorVerIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionDelByMajorVerIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionDelByMajorVerIdx" );
			...
			// Delete the objects
			schemaObj.getMinorVersionTableObj().deleteMinorVersionByMajorVerIdx( natTenantId,
				natMajorVersionId );
