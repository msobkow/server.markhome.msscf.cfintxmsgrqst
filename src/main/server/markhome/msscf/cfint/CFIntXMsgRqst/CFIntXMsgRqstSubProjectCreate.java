...
/*
 *	CFIntXMsgRqstSubProjectCreate XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntSubProjectBuff dataBuff = (CFIntSubProjectBuff)editBuff.getSubProjectBuff();
			// Extract Attributes
			...
			ICFIntSubProjectObj created = (ICFIntSubProjectObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSubProjectMessageFormatter.formatSubProjectRspnCreated( "\n\t\t\t", created.getSubProjectBuff() )
				+	"\n"
