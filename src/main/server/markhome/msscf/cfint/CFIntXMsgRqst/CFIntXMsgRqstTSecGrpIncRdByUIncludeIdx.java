...
/*
 *	CFIntXMsgRqstTSecGrpIncRdBy XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncRdByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncRdByUIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncRdByUIncludeIdx" );
			...
			// Read the object
			ICFIntTSecGrpIncObj read = ((ICFIntTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().readTSecGrpIncByUIncludeIdx( natTenantId,
				natTSecGroupId,
				natIncludeGroupId,
				true ));
			if( read != null ) {
