 ...
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTopDomainDelByIdIdx" );
