...
/*
 *	CFIntXMsgRqstTopProjectDelBy XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRqstTopProjectDelByTopDomainIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopProjectDelByTopDomainIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTopProjectDelByTopDomainIdx" );
			...
			// Delete the objects
			schemaObj.getTopProjectTableObj().deleteTopProjectByTopDomainIdx( natTenantId,
				natTopDomainId );
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTopProjectMessageFormatter.formatTopProjectRspnDeleted() +	"\n"
