 ...
 *	for Service.
 */
public class CFIntXMsgRqstServicePageByHostIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServicePageByHostIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServicePageByHostIdx" );
			...
			// Page the objects
			List<ICFSecServiceObj> list = schemaObj.getServiceTableObj().pageServiceByHostIdx( natClusterId,
				natHostNodeId,
				natPriorClusterId,
				natPriorServiceId );
