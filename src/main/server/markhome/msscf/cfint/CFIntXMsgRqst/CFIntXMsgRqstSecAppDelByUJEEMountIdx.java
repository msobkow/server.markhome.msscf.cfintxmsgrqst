...
/*
 *	CFIntXMsgRqstSecAppDelBy XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppDelByUJEEMountIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppDelByUJEEMountIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecAppDelByUJEEMountIdx" );
