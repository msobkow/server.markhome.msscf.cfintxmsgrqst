...
/*
 *	CFIntXMsgRqstSecGroupDelBy XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupDelByClusterVisIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupDelByClusterVisIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupDelByClusterVisIdx" );
			...
			// Delete the objects
			schemaObj.getSecGroupTableObj().deleteSecGroupByClusterVisIdx( natClusterId,
				natIsVisible );
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnDeleted() +	"\n"
