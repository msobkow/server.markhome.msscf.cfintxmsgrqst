...
/*
 *	CFIntXMsgRqstSecGroupFormRdBy XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRdByUFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRdByUFormIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormRdByUFormIdx" );
			...
			// Read the object
			ICFIntSecGroupFormObj read = ((ICFIntSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupFormByUFormIdx( natClusterId,
				natSecGroupId,
				natSecFormId,
				true ));
			if( read != null ) {
