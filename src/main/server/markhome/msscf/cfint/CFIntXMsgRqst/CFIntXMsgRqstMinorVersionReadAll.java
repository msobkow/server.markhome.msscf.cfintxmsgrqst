...
// Description: Java 11 XML Message SAX Request Read All Element  for MinorVersion
...
/*
 *	CFIntXMsgRqstMinorVersionReadAll XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFIntMinorVersionObj> list = schemaObj.getMinorVersionTableObj().readAllMinorVersion( true );
