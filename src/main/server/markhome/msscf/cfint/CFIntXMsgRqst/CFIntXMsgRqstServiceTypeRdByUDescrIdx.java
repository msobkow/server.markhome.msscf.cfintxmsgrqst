...
/*
 *	CFIntXMsgRqstServiceTypeRdBy XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeRdByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeRdByUDescrIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFIntServiceTypeObj read = ((ICFIntServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceTypeByUDescrIdx( natDescription,
				true ));
			if( read != null ) {
