 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceRdByTypeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceRdByTypeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceRdByTypeIdx" );
			...
			// Read the objects
			List<ICFSecServiceObj> list = schemaObj.getServiceTableObj().readServiceByTypeIdx( natServiceTypeId );
