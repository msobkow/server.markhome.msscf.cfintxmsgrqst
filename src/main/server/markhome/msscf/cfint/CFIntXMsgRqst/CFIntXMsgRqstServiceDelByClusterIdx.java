 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceDelByClusterIdx" );
