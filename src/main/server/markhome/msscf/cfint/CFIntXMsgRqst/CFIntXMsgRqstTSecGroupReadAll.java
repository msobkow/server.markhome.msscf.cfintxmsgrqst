...
// Description: Java 11 XML Message SAX Request Read All Element  for TSecGroup
...
/*
 *	CFIntXMsgRqstTSecGroupReadAll XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecTSecGroupObj> list = schemaObj.getTSecGroupTableObj().readAllTSecGroup( true );
