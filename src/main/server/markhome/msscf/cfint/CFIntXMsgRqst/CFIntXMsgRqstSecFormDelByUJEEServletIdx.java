...
/*
 *	CFIntXMsgRqstSecFormDelBy XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormDelByUJEEServletIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormDelByUJEEServletIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormDelByUJEEServletIdx" );
