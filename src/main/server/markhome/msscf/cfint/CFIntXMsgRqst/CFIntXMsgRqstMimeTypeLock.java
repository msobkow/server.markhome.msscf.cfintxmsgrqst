...
/*
 *	CFIntXMsgRqstMimeTypeLock XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRqstMimeTypeLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMimeTypeLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredMimeTypeId( natMimeTypeId );
			// Lock the object
			ICFIntMimeTypeObj locked = ((ICFIntMimeTypeObj)schemaObj.getMimeTypeTableObj().lockMimeType( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgMimeTypeMessageFormatter.formatMimeTypeRspnLocked( "\n\t\t\t", locked.getMimeTypeBuff() )
				+	"\n"
