...
/*
 *	CFIntXMsgRqstSecDeviceRdBy XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceRdByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceRdByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecDeviceRdByUserIdx" );
			...
			// Read the objects
			List<ICFSecSecDeviceObj> list = schemaObj.getSecDeviceTableObj().readSecDeviceByUserIdx( natSecUserId );
