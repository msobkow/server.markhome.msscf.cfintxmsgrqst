 ...
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyDelByCcyNmIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyDelByCcyNmIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyDelByCcyNmIdx" );
			...
			// Delete the objects
			schemaObj.getISOCcyTableObj().deleteISOCcyByCcyNmIdx( natName );
