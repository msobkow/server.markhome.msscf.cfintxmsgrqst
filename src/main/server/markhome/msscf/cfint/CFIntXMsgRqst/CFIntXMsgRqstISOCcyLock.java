...
/*
 *	CFIntXMsgRqstISOCcyLock XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyLock" );
			...
			pkey.setRequiredISOCcyId( natISOCcyId );
			// Lock the object
			ICFIntISOCcyObj locked = ((ICFIntISOCcyObj)schemaObj.getISOCcyTableObj().lockISOCcy( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCcyMessageFormatter.formatISOCcyRspnLocked( "\n\t\t\t", locked.getISOCcyBuff() )
				+	"\n"
