...
/*
 *	CFIntXMsgRqstISOTZoneLock XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneLock" );
			...
			pkey.setRequiredISOTZoneId( natISOTZoneId );
			// Lock the object
			ICFIntISOTZoneObj locked = ((ICFIntISOTZoneObj)schemaObj.getISOTZoneTableObj().lockISOTZone( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOTZoneMessageFormatter.formatISOTZoneRspnLocked( "\n\t\t\t", locked.getISOTZoneBuff() )
				+	"\n"
