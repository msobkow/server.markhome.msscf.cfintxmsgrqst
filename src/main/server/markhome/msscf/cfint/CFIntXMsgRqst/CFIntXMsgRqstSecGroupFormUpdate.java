...
/*
 *	CFIntXMsgRqstSecGroupFormUpdate XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntSecGroupFormObj origBuff = ((ICFIntSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupForm( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntSecGroupFormEditObj editBuff = (ICFIntSecGroupFormEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnUpdated( "\n\t\t\t", origBuff.getSecGroupFormBuff() )
					+	"\n"
