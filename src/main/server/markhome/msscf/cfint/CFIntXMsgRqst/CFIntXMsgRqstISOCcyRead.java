...
/*
 *	CFIntXMsgRqstISOCcyRead XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyRead" );
			...
			ICFIntISOCcyObj read = ((ICFIntISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcy( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgISOCcyMessageFormatter.formatISOCcyRspnSingleOpenTag()
					+	CFIntXMsgISOCcyMessageFormatter.formatISOCcyRspnDerivedRec( "\n\t\t", read.getISOCcyBuff() ) + "\n"
					+	"\t" + CFIntXMsgISOCcyMessageFormatter.formatISOCcyRspnSingleCloseTag()
