...
// Description: Java 11 XML Message SAX Request Read All Element  for ISOCtryLang
...
/*
 *	CFIntXMsgRqstISOCtryLangReadAll XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryLangReadAll" );
			...
			List<ICFSecISOCtryLangObj> list = schemaObj.getISOCtryLangTableObj().readAllISOCtryLang( true );
