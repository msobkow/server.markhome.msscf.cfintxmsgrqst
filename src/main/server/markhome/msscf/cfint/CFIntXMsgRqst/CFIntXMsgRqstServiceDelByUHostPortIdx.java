...
/*
 *	CFIntXMsgRqstServiceDelBy XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelByUHostPortIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelByUHostPortIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceDelByUHostPortIdx" );
