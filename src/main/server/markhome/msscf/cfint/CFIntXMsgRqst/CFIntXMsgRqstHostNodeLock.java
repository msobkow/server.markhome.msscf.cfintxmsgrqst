...
/*
 *	CFIntXMsgRqstHostNodeLock XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredHostNodeId( natHostNodeId );
			// Lock the object
			ICFIntHostNodeObj locked = ((ICFIntHostNodeObj)schemaObj.getHostNodeTableObj().lockHostNode( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgHostNodeMessageFormatter.formatHostNodeRspnLocked( "\n\t\t\t", locked.getHostNodeBuff() )
				+	"\n"
