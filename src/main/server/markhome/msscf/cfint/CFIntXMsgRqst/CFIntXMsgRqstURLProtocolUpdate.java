...
/*
 *	CFIntXMsgRqstURLProtocolUpdate XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntURLProtocolObj origBuff = ((ICFIntURLProtocolObj)schemaObj.getURLProtocolTableObj().readURLProtocol( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntURLProtocolEditObj editBuff = (ICFIntURLProtocolEditObj)origBuff.beginEdit();
				CFIntURLProtocolBuff dataBuff = editBuff.getURLProtocolBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRspnUpdated( "\n\t\t\t", origBuff.getURLProtocolBuff() )
					+	"\n"
