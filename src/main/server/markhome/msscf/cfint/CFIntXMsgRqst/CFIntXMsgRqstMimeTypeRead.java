...
/*
 *	CFIntXMsgRqstMimeTypeRead XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRqstMimeTypeRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMimeTypeRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntMimeTypePKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactoryMimeType().newPKey();
			...
			ICFIntMimeTypeObj read = ((ICFIntMimeTypeObj)schemaObj.getMimeTypeTableObj().readMimeType( pkey, true ));
			if( read != null ) {
