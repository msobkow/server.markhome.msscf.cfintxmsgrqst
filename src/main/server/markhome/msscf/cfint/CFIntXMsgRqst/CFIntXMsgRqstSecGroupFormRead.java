...
/*
 *	CFIntXMsgRqstSecGroupFormRead XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecGroupFormPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactorySecGroupForm().newPKey();
			...
			ICFIntSecGroupFormObj read = ((ICFIntSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupForm( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnSingleOpenTag()
					+	CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnDerivedRec( "\n\t\t", read.getSecGroupFormBuff() ) + "\n"
					+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnSingleCloseTag()
