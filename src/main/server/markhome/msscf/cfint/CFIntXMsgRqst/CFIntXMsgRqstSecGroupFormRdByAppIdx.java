 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRdByAppIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRdByAppIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormRdByAppIdx" );
			...
			// Read the objects
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().readSecGroupFormByAppIdx( natClusterId,
				natSecAppId );
