...
/*
 *	CFIntXMsgRqstSecGroupFormDelete XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSecGroupFormObj read = ((ICFIntSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupForm( pkey ));
			if( read != null ) {
				if( read.getSecGroupFormBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSecGroupFormEditObj editBuff = (ICFIntSecGroupFormEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnDeleted() +	"\n"
