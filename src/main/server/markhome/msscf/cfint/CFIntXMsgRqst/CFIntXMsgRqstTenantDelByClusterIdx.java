...
/*
 *	CFIntXMsgRqstTenantDelBy XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTenantDelByClusterIdx" );
