...
/*
 *	CFIntXMsgRqstMinorVersionLock XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntMinorVersionObj locked = ((ICFIntMinorVersionObj)schemaObj.getMinorVersionTableObj().lockMinorVersion( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnLocked( "\n\t\t\t", locked.getMinorVersionBuff() )
				+	"\n"
