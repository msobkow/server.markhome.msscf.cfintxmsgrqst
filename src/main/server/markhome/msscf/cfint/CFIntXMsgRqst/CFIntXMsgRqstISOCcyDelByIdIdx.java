 ...
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getISOCcyTableObj().deleteISOCcyByIdIdx( natISOCcyId );
