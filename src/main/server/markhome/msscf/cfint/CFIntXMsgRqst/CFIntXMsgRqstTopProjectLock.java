...
/*
 *	CFIntXMsgRqstTopProjectLock XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRqstTopProjectLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopProjectLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntTopProjectObj locked = ((ICFIntTopProjectObj)schemaObj.getTopProjectTableObj().lockTopProject( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTopProjectMessageFormatter.formatTopProjectRspnLocked( "\n\t\t\t", locked.getTopProjectBuff() )
				+	"\n"
