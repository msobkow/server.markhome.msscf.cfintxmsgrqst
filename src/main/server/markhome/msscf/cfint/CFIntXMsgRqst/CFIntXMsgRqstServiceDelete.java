...
/*
 *	CFIntXMsgRqstServiceDelete XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntServiceObj read = ((ICFIntServiceObj)schemaObj.getServiceTableObj().readService( pkey ));
			if( read != null ) {
				if( read.getServiceBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntServiceEditObj editBuff = (ICFIntServiceEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnDeleted() +	"\n"
