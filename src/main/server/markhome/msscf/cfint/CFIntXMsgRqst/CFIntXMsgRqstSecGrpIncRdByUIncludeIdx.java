...
/*
 *	CFIntXMsgRqstSecGrpIncRdBy XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncRdByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncRdByUIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncRdByUIncludeIdx" );
			...
			// Read the object
			ICFIntSecGrpIncObj read = ((ICFIntSecGrpIncObj)schemaObj.getSecGrpIncTableObj().readSecGrpIncByUIncludeIdx( natClusterId,
				natSecGroupId,
				natIncludeGroupId,
				true ));
			if( read != null ) {
