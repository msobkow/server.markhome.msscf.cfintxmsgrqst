...
/*
 *	CFIntXMsgRqstSecFormUpdate XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntSecFormObj origBuff = ((ICFIntSecFormObj)schemaObj.getSecFormTableObj().readSecForm( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntSecFormEditObj editBuff = (ICFIntSecFormEditObj)origBuff.beginEdit();
				CFSecSecFormBuff dataBuff = editBuff.getSecFormBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnUpdated( "\n\t\t\t", origBuff.getSecFormBuff() )
					+	"\n"
