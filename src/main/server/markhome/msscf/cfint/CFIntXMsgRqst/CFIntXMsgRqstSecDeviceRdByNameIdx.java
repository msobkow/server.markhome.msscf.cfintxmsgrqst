 ...
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceRdByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceRdByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFIntSecDeviceObj read = ((ICFIntSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDeviceByNameIdx( natSecUserId,
				natDevName,
				true ));
			if( read != null ) {
