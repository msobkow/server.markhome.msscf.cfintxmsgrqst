 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormDelByIdIdx" );
