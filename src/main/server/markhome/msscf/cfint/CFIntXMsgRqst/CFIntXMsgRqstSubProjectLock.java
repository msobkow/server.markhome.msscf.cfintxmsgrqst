...
/*
 *	CFIntXMsgRqstSubProjectLock XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntSubProjectObj locked = ((ICFIntSubProjectObj)schemaObj.getSubProjectTableObj().lockSubProject( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSubProjectMessageFormatter.formatSubProjectRspnLocked( "\n\t\t\t", locked.getSubProjectBuff() )
				+	"\n"
