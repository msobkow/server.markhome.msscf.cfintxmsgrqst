 ...
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeDelByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeDelByUDescrIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstHostNodeDelByUDescrIdx" );
