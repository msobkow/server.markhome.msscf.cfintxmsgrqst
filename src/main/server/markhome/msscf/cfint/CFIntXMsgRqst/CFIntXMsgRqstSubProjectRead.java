...
/*
 *	CFIntXMsgRqstSubProjectRead XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntSubProjectObj read = ((ICFIntSubProjectObj)schemaObj.getSubProjectTableObj().readSubProject( pkey, true ));
			if( read != null ) {
