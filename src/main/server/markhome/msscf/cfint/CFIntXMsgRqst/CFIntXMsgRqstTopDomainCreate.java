...
/*
 *	CFIntXMsgRqstTopDomainCreate XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntTopDomainBuff dataBuff = (CFIntTopDomainBuff)editBuff.getTopDomainBuff();
			// Extract Attributes
			...
			ICFIntTopDomainObj created = (ICFIntTopDomainObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTopDomainMessageFormatter.formatTopDomainRspnCreated( "\n\t\t\t", created.getTopDomainBuff() )
				+	"\n"
