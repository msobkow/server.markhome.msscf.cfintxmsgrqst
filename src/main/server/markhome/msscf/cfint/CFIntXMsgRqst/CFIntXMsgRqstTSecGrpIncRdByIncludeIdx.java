 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncRdByIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncRdByIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncRdByIncludeIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpIncObj> list = schemaObj.getTSecGrpIncTableObj().readTSecGrpIncByIncludeIdx( natTenantId,
				natIncludeGroupId );
