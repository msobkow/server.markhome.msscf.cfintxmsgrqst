 ...
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceDelByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceDelByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecDeviceDelByUserIdx" );
