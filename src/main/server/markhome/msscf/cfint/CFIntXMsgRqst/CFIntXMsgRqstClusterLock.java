...
/*
 *	CFIntXMsgRqstClusterLock XML SAX Element  implementation
 *	for Cluster.
 */
public class CFIntXMsgRqstClusterLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstClusterLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntClusterObj locked = ((ICFIntClusterObj)schemaObj.getClusterTableObj().lockCluster( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgClusterMessageFormatter.formatClusterRspnLocked( "\n\t\t\t", locked.getClusterBuff() )
				+	"\n"
