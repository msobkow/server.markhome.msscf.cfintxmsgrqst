...
/*
 *	CFIntXMsgRqstSecGroupLock XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecGroupId( natSecGroupId );
			// Lock the object
			ICFIntSecGroupObj locked = ((ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().lockSecGroup( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnLocked( "\n\t\t\t", locked.getSecGroupBuff() )
				+	"\n"
