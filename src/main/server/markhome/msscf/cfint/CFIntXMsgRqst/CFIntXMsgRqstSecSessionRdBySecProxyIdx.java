 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRdBySecProxyIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRdBySecProxyIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionRdBySecProxyIdx" );
			...
			// Read the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().readSecSessionBySecProxyIdx( natSecProxyId );
