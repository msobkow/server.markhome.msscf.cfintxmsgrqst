...
// Description: Java 11 XML Message SAX Request Page All Element  for SecUser
...
/*
 *	CFIntXMsgRqstSecUserPageAll XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserPageAll" );
			...
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().pageAllSecUser( natPriorSecUserId );
