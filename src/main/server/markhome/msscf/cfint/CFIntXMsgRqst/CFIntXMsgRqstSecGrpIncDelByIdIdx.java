...
/*
 *	CFIntXMsgRqstSecGrpIncDelBy XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpIncTableObj().deleteSecGrpIncByIdIdx( natClusterId,
				natSecGrpIncId );
