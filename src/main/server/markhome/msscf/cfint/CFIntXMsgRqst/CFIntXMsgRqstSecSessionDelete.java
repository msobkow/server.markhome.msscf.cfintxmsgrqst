...
/*
 *	CFIntXMsgRqstSecSessionDelete XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSecSessionObj read = ((ICFIntSecSessionObj)schemaObj.getSecSessionTableObj().readSecSession( pkey ));
			if( read != null ) {
				if( read.getSecSessionBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSecSessionEditObj editBuff = (ICFIntSecSessionEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgSecSessionMessageFormatter.formatSecSessionRspnDeleted() +	"\n"
