...
/*
 *	CFIntXMsgRqstServiceTypeDelete XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntServiceTypeObj read = ((ICFIntServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceType( pkey ));
			if( read != null ) {
				if( read.getServiceTypeBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntServiceTypeEditObj editBuff = (ICFIntServiceTypeEditObj)read.beginEdit();
					if( editBuff != null ) {
