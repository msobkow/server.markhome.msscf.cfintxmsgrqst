...
/*
 *	CFIntXMsgRqstSecDevicePageBy XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDevicePageByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDevicePageByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
