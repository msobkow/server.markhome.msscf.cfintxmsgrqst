...
/*
 *	CFIntXMsgRqstURLProtocolLock XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredURLProtocolId( natURLProtocolId );
			// Lock the object
			ICFIntURLProtocolObj locked = ((ICFIntURLProtocolObj)schemaObj.getURLProtocolTableObj().lockURLProtocol( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRspnLocked( "\n\t\t\t", locked.getURLProtocolBuff() )
				+	"\n"
