...
/*
 *	CFIntXMsgRqstServiceLock XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredServiceId( natServiceId );
			// Lock the object
			ICFIntServiceObj locked = ((ICFIntServiceObj)schemaObj.getServiceTableObj().lockService( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnLocked( "\n\t\t\t", locked.getServiceBuff() )
				+	"\n"
