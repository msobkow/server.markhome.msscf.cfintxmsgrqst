...
/*
 *	CFIntXMsgRqstTSecGroupRead XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntTSecGroupObj read = ((ICFIntTSecGroupObj)schemaObj.getTSecGroupTableObj().readTSecGroup( pkey, true ));
			if( read != null ) {
