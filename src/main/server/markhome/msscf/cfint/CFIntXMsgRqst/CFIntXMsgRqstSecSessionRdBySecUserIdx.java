 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRdBySecUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRdBySecUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionRdBySecUserIdx" );
			...
			// Read the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().readSecSessionBySecUserIdx( natSecUserId );
