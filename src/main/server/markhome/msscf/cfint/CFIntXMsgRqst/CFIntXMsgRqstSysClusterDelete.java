...
/*
 *	CFIntXMsgRqstSysClusterDelete XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSysClusterObj read = ((ICFIntSysClusterObj)schemaObj.getSysClusterTableObj().readSysCluster( pkey ));
			if( read != null ) {
				if( read.getSysClusterBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSysClusterEditObj editBuff = (ICFIntSysClusterEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnDeleted() +	"\n"
