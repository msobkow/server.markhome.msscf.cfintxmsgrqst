 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelByFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelByFormIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormDelByFormIdx" );
