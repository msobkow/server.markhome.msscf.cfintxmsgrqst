 ...
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantRdByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantRdByUNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTenantRdByUNameIdx" );
			...
			// Read the object
			ICFIntTenantObj read = ((ICFIntTenantObj)schemaObj.getTenantTableObj().readTenantByUNameIdx( natClusterId,
				natTenantName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTenantMessageFormatter.formatTenantRspnSingleOpenTag()
					+	CFIntXMsgTenantMessageFormatter.formatTenantRspnDerivedRec( "\n\t\t", read.getTenantBuff() ) + "\n"
					+	"\t" + CFIntXMsgTenantMessageFormatter.formatTenantRspnSingleCloseTag()
