 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelByTypeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelByTypeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceDelByTypeIdx" );
