 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserPageByEMConfIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserPageByEMConfIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserPageByEMConfIdx" );
			...
			// Page the objects
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().pageSecUserByEMConfIdx( natEMailConfirmUuid,
				natPriorSecUserId );
