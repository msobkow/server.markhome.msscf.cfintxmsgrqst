 ...
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormDelByClusterIdx" );
