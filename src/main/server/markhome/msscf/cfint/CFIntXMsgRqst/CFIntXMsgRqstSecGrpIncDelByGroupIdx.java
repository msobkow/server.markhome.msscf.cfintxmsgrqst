 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncDelByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncDelByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncDelByGroupIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpIncTableObj().deleteSecGrpIncByGroupIdx( natClusterId,
				natSecGroupId );
