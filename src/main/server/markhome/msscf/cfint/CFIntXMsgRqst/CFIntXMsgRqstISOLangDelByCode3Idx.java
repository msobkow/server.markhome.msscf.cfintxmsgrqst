...
/*
 *	CFIntXMsgRqstISOLangDelBy XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangDelByCode3Idx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangDelByCode3Idx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangDelByCode3Idx" );
			...
			String natISO6392Code;
			natISO6392Code = attrISO6392Code;

			// Delete the objects
			schemaObj.getISOLangTableObj().deleteISOLangByCode3Idx( natISO6392Code );
