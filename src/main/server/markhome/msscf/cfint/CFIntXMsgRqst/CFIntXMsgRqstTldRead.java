...
/*
 *	CFIntXMsgRqstTldRead XML SAX Element  implementation
 *	for Tld.
 */
public class CFIntXMsgRqstTldRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTldRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntTldPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactoryTld().newPKey();
			...
			ICFIntTldObj read = ((ICFIntTldObj)schemaObj.getTldTableObj().readTld( pkey, true ));
			if( read != null ) {
