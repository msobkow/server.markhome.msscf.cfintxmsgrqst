 ...
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneDelByUTZNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneDelByUTZNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneDelByUTZNameIdx" );
			...
			// Delete the objects
			schemaObj.getISOTZoneTableObj().deleteISOTZoneByUTZNameIdx( natTZName );
