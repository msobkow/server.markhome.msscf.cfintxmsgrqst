...
/*
 *	CFIntXMsgRqstSecGroupDelete XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSecGroupObj read = ((ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroup( pkey ));
			if( read != null ) {
				if( read.getSecGroupBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSecGroupEditObj editBuff = (ICFIntSecGroupEditObj)read.beginEdit();
					if( editBuff != null ) {
