 ...
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionDelByIdIdx" );
