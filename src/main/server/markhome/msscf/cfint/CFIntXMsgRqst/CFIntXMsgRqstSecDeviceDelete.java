...
/*
 *	CFIntXMsgRqstSecDeviceDelete XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSecDeviceObj read = ((ICFIntSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDevice( pkey ));
			if( read != null ) {
				if( read.getSecDeviceBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSecDeviceEditObj editBuff = (ICFIntSecDeviceEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRspnDeleted() +	"\n"
