...
/*
 *	CFIntXMsgRqstSecGroupFormDelBy XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormDelByClusterIdx" );
