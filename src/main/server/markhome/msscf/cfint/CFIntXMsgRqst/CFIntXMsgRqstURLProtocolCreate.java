...
/*
 *	CFIntXMsgRqstURLProtocolCreate XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntURLProtocolBuff dataBuff = (CFIntURLProtocolBuff)editBuff.getURLProtocolBuff();
			// Extract Attributes
			...
			ICFIntURLProtocolObj created = (ICFIntURLProtocolObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRspnCreated( "\n\t\t\t", created.getURLProtocolBuff() )
				+	"\n"
