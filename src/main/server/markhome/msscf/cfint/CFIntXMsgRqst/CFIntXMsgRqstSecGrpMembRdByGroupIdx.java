 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembRdByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembRdByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembRdByGroupIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpMembObj> list = schemaObj.getSecGrpMembTableObj().readSecGrpMembByGroupIdx( natClusterId,
				natSecGroupId );
