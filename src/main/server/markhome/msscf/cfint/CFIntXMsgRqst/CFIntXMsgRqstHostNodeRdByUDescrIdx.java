 ...
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeRdByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeRdByUDescrIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstHostNodeRdByUDescrIdx" );
			...
			// Read the object
			ICFIntHostNodeObj read = ((ICFIntHostNodeObj)schemaObj.getHostNodeTableObj().readHostNodeByUDescrIdx( natClusterId,
				natDescription,
				true ));
			if( read != null ) {
