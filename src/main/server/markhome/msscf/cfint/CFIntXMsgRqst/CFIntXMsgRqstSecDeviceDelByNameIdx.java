...
/*
 *	CFIntXMsgRqstSecDeviceDelBy XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceDelByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecDeviceDelByNameIdx" );
			...
			// Delete the objects
			schemaObj.getSecDeviceTableObj().deleteSecDeviceByNameIdx( natSecUserId,
				natDevName );
