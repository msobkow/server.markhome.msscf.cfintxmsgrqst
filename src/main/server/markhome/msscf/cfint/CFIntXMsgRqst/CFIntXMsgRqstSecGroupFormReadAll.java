...
// Description: Java 11 XML Message SAX Request Read All Element  for SecGroupForm
...
/*
 *	CFIntXMsgRqstSecGroupFormReadAll XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().readAllSecGroupForm( true );
