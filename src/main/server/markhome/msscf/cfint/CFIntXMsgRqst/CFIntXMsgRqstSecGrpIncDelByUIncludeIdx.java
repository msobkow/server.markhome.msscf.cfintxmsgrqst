 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncDelByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncDelByUIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncDelByUIncludeIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpIncTableObj().deleteSecGrpIncByUIncludeIdx( natClusterId,
				natSecGroupId,
				natIncludeGroupId );
