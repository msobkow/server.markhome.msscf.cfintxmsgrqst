...
/*
 *	CFIntXMsgRqstISOCtryCcyDelete XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntISOCtryCcyObj read = ((ICFIntISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().readISOCtryCcy( pkey ));
			if( read != null ) {
				if( read.getISOCtryCcyBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntISOCtryCcyEditObj editBuff = (ICFIntISOCtryCcyEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnDeleted() +	"\n"
