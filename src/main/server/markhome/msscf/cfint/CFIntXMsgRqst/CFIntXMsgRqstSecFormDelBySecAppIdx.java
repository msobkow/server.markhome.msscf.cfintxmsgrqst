 ...
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormDelBySecAppIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormDelBySecAppIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormDelBySecAppIdx" );
