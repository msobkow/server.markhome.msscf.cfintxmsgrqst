...
// Description: Java 11 XML Message SAX Request Read All Element  for TSecGrpMemb
...
/*
 *	CFIntXMsgRqstTSecGrpMembReadAll XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembReadAll" );
			...
			List<ICFSecTSecGrpMembObj> list = schemaObj.getTSecGrpMembTableObj().readAllTSecGrpMemb( true );
