 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembRdByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembRdByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembRdByGroupIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpMembObj> list = schemaObj.getTSecGrpMembTableObj().readTSecGrpMembByGroupIdx( natTenantId,
				natTSecGroupId );
