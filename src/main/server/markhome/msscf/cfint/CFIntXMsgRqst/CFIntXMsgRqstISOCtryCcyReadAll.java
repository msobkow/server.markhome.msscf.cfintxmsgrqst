...
// Description: Java 11 XML Message SAX Request Read All Element  for ISOCtryCcy
...
/*
 *	CFIntXMsgRqstISOCtryCcyReadAll XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyReadAll" );
			...
			List<ICFSecISOCtryCcyObj> list = schemaObj.getISOCtryCcyTableObj().readAllISOCtryCcy( true );
