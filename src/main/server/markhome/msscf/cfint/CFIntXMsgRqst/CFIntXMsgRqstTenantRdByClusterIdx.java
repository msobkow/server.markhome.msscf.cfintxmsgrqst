...
/*
 *	CFIntXMsgRqstTenantRdBy XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTenantRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecTenantObj> list = schemaObj.getTenantTableObj().readTenantByClusterIdx( natClusterId );
