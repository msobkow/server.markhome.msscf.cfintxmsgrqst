...
/*
 *	CFIntXMsgRqstISOCtryLangCreate XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntISOCtryLangObj created = (ICFIntISOCtryLangObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnCreated( "\n\t\t\t", created.getISOCtryLangBuff() )
				+	"\n"
