 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncDelByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncDelByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncDelByGroupIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpIncTableObj().deleteTSecGrpIncByGroupIdx( natTenantId,
				natTSecGroupId );
