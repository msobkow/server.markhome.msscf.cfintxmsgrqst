...
// Description: Java 11 XML Message SAX Request Read All Element  for HostNode
...
/*
 *	CFIntXMsgRqstHostNodeReadAll XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecHostNodeObj> list = schemaObj.getHostNodeTableObj().readAllHostNode( true );
