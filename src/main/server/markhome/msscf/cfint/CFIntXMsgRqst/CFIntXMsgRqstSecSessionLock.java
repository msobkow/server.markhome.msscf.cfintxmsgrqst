...
/*
 *	CFIntXMsgRqstSecSessionLock XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecSessionId( natSecSessionId );
			// Lock the object
			ICFIntSecSessionObj locked = ((ICFIntSecSessionObj)schemaObj.getSecSessionTableObj().lockSecSession( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecSessionMessageFormatter.formatSecSessionRspnLocked( "\n\t\t\t", locked.getSecSessionBuff() )
				+	"\n"
