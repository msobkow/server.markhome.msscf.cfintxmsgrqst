 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncRdByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncRdByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncRdByTenantIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpIncObj> list = schemaObj.getTSecGrpIncTableObj().readTSecGrpIncByTenantIdx( natTenantId );
