...
/*
 *	CFIntXMsgRqstServiceTypeCreate XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecServiceTypeBuff dataBuff = (CFSecServiceTypeBuff)editBuff.getServiceTypeBuff();
			// Extract Attributes
			...
			ICFIntServiceTypeObj created = (ICFIntServiceTypeObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnCreated( "\n\t\t\t", created.getServiceTypeBuff() )
				+	"\n"
