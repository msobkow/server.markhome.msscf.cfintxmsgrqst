...
// Description: Java 11 XML Message SAX Request Read All Element  for URLProtocol
...
/*
 *	CFIntXMsgRqstURLProtocolReadAll XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFIntURLProtocolObj> list = schemaObj.getURLProtocolTableObj().readAllURLProtocol( true );
