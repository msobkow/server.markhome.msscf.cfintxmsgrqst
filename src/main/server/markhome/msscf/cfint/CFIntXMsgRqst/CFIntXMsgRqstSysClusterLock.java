...
/*
 *	CFIntXMsgRqstSysClusterLock XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSingletonId( natSingletonId );
			// Lock the object
			ICFIntSysClusterObj locked = ((ICFIntSysClusterObj)schemaObj.getSysClusterTableObj().lockSysCluster( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnLocked( "\n\t\t\t", locked.getSysClusterBuff() )
				+	"\n"
