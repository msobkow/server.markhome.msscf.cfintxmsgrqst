...
/*
 *	CFIntXMsgRqstServiceTypeLock XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredServiceTypeId( natServiceTypeId );
			// Lock the object
			ICFIntServiceTypeObj locked = ((ICFIntServiceTypeObj)schemaObj.getServiceTypeTableObj().lockServiceType( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnLocked( "\n\t\t\t", locked.getServiceTypeBuff() )
				+	"\n"
