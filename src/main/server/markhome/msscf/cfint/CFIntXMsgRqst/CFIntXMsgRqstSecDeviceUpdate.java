...
/*
 *	CFIntXMsgRqstSecDeviceUpdate XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntSecDeviceObj origBuff = ((ICFIntSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDevice( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntSecDeviceEditObj editBuff = (ICFIntSecDeviceEditObj)origBuff.beginEdit();
				CFSecSecDeviceBuff dataBuff = editBuff.getSecDeviceBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRspnUpdated( "\n\t\t\t", origBuff.getSecDeviceBuff() )
					+	"\n"
