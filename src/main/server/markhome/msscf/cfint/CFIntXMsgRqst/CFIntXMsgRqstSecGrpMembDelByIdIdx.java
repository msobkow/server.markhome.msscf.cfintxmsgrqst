...
/*
 *	CFIntXMsgRqstSecGrpMembDelBy XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpMembTableObj().deleteSecGrpMembByIdIdx( natClusterId,
				natSecGrpMembId );
