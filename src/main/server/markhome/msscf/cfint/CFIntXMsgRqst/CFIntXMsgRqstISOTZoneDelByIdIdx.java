...
/*
 *	CFIntXMsgRqstISOTZoneDelBy XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getISOTZoneTableObj().deleteISOTZoneByIdIdx( natISOTZoneId );
