 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserRdByULoginIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserRdByULoginIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserRdByULoginIdx" );
			...
			// Read the object
			ICFIntSecUserObj read = ((ICFIntSecUserObj)schemaObj.getSecUserTableObj().readSecUserByULoginIdx( natLoginId,
				true ));
			if( read != null ) {
