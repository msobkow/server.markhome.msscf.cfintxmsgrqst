...
/*
 *	CFIntXMsgRqstTenantLock XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntTenantObj locked = ((ICFIntTenantObj)schemaObj.getTenantTableObj().lockTenant( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTenantMessageFormatter.formatTenantRspnLocked( "\n\t\t\t", locked.getTenantBuff() )
				+	"\n"
