 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncDelByIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncDelByIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncDelByIncludeIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpIncTableObj().deleteSecGrpIncByIncludeIdx( natClusterId,
				natIncludeGroupId );
