...
/*
 *	CFIntXMsgRqstISOCtryCcyLock XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyLock" );
			...
			pkey.setRequiredISOCcyId( natISOCcyId );
			// Lock the object
			ICFIntISOCtryCcyObj locked = ((ICFIntISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().lockISOCtryCcy( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnLocked( "\n\t\t\t", locked.getISOCtryCcyBuff() )
				+	"\n"
