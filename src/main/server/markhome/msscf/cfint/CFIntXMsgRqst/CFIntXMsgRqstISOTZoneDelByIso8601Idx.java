 ...
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneDelByIso8601Idx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneDelByIso8601Idx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneDelByIso8601Idx" );
			...
			// Delete the objects
			schemaObj.getISOTZoneTableObj().deleteISOTZoneByIso8601Idx( natIso8601 );
