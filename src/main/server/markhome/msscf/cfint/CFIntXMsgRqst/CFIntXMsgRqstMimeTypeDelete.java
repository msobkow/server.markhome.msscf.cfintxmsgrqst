...
/*
 *	CFIntXMsgRqstMimeTypeDelete XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRqstMimeTypeDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMimeTypeDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntMimeTypeObj read = ((ICFIntMimeTypeObj)schemaObj.getMimeTypeTableObj().readMimeType( pkey ));
			if( read != null ) {
				if( read.getMimeTypeBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntMimeTypeEditObj editBuff = (ICFIntMimeTypeEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgMimeTypeMessageFormatter.formatMimeTypeRspnDeleted() +	"\n"
