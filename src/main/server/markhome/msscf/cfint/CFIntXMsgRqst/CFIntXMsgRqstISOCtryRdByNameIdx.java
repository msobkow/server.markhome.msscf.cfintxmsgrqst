 ...
 *	for ISOCtry.
 */
public class CFIntXMsgRqstISOCtryRdByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryRdByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryRdByNameIdx" );
			...
			// Read the object
			ICFIntISOCtryObj read = ((ICFIntISOCtryObj)schemaObj.getISOCtryTableObj().readISOCtryByNameIdx( natName,
				true ));
			if( read != null ) {
