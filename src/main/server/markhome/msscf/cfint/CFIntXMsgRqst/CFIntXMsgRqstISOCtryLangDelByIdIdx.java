 ...
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryLangDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryLangTableObj().deleteISOCtryLangByIdIdx( natISOCtryId,
				natISOLangId );
