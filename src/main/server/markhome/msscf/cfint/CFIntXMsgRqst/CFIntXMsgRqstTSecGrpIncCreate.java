...
/*
 *	CFIntXMsgRqstTSecGrpIncCreate XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncCreate" );
			...
			CFSecTSecGrpIncBuff dataBuff = (CFSecTSecGrpIncBuff)editBuff.getTSecGrpIncBuff();
			// Extract Attributes
			...
			ICFIntTSecGrpIncObj created = (ICFIntTSecGrpIncObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRspnCreated( "\n\t\t\t", created.getTSecGrpIncBuff() )
				+	"\n"
