...
/*
 *	CFIntXMsgRqstTSecGrpMembRdBy XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembRdByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembRdByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembRdByTenantIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpMembObj> list = schemaObj.getTSecGrpMembTableObj().readTSecGrpMembByTenantIdx( natTenantId );
