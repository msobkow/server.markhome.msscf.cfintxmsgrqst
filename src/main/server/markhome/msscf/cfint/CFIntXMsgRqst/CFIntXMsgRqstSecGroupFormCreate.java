...
/*
 *	CFIntXMsgRqstSecGroupFormCreate XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecGroupFormBuff dataBuff = (CFSecSecGroupFormBuff)editBuff.getSecGroupFormBuff();
			// Extract Attributes
			...
			ICFIntSecGroupFormObj created = (ICFIntSecGroupFormObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnCreated( "\n\t\t\t", created.getSecGroupFormBuff() )
				+	"\n"
