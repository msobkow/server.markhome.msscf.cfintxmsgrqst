...
/*
 *	CFIntXMsgRqstHostNodeDelBy XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeDelByHostNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeDelByHostNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstHostNodeDelByHostNameIdx" );
