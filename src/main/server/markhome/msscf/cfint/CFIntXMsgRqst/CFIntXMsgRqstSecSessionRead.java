...
/*
 *	CFIntXMsgRqstSecSessionRead XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntSecSessionObj read = ((ICFIntSecSessionObj)schemaObj.getSecSessionTableObj().readSecSession( pkey, true ));
			if( read != null ) {
