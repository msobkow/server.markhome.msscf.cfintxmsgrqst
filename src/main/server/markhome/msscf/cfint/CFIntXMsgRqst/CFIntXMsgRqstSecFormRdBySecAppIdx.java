 ...
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormRdBySecAppIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormRdBySecAppIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormRdBySecAppIdx" );
			...
			// Read the objects
			List<ICFSecSecFormObj> list = schemaObj.getSecFormTableObj().readSecFormBySecAppIdx( natClusterId,
				natSecAppId );
