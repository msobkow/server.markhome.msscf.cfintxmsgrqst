 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembRdByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembRdByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembRdByUserIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpMembObj> list = schemaObj.getSecGrpMembTableObj().readSecGrpMembByUserIdx( natSecUserId );
