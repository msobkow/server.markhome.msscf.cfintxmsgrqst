...
/*
 *	CFIntXMsgRqstTSecGroupCreate XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecTSecGroupBuff dataBuff = (CFSecTSecGroupBuff)editBuff.getTSecGroupBuff();
			// Extract Attributes
			...
			ICFIntTSecGroupObj created = (ICFIntTSecGroupObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTSecGroupMessageFormatter.formatTSecGroupRspnCreated( "\n\t\t\t", created.getTSecGroupBuff() )
				+	"\n"
