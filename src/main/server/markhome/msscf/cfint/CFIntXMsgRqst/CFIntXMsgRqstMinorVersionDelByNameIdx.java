 ...
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionDelByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionDelByNameIdx" );
