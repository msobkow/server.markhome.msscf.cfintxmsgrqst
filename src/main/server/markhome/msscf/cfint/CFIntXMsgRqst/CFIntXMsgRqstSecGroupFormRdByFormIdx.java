 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRdByFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRdByFormIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormRdByFormIdx" );
			...
			// Read the objects
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().readSecGroupFormByFormIdx( natClusterId,
				natSecFormId );
