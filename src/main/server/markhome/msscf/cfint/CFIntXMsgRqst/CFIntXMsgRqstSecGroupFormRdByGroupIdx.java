 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRdByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRdByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormRdByGroupIdx" );
			...
			// Read the objects
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().readSecGroupFormByGroupIdx( natClusterId,
				natSecGroupId );
