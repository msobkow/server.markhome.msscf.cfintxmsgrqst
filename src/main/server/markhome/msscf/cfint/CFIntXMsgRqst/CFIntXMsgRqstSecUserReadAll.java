...
// Description: Java 11 XML Message SAX Request Read All Element  for SecUser
...
/*
 *	CFIntXMsgRqstSecUserReadAll XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().readAllSecUser( true );
