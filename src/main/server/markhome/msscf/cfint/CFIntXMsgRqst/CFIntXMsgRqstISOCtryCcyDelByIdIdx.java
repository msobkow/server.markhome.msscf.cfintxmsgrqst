 ...
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryCcyTableObj().deleteISOCtryCcyByIdIdx( natISOCtryId,
				natISOCcyId );
