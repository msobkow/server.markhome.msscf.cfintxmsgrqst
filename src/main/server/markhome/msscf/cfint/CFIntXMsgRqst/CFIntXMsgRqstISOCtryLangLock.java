...
/*
 *	CFIntXMsgRqstISOCtryLangLock XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryLangLock" );
			...
			pkey.setRequiredISOLangId( natISOLangId );
			// Lock the object
			ICFIntISOCtryLangObj locked = ((ICFIntISOCtryLangObj)schemaObj.getISOCtryLangTableObj().lockISOCtryLang( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnLocked( "\n\t\t\t", locked.getISOCtryLangBuff() )
				+	"\n"
