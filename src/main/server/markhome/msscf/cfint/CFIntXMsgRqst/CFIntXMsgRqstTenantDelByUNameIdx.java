 ...
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantDelByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantDelByUNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTenantDelByUNameIdx" );
