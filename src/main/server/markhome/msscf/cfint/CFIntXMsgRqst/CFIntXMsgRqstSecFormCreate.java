...
/*
 *	CFIntXMsgRqstSecFormCreate XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecFormBuff dataBuff = (CFSecSecFormBuff)editBuff.getSecFormBuff();
			// Extract Attributes
			...
			ICFIntSecFormObj created = (ICFIntSecFormObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnCreated( "\n\t\t\t", created.getSecFormBuff() )
				+	"\n"
