 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceRdByUTypeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceRdByUTypeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceRdByUTypeIdx" );
			...
			// Read the object
			ICFIntServiceObj read = ((ICFIntServiceObj)schemaObj.getServiceTableObj().readServiceByUTypeIdx( natClusterId,
				natHostNodeId,
				natServiceTypeId,
				true ));
			if( read != null ) {
