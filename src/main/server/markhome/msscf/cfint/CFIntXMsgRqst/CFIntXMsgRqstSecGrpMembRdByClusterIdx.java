...
/*
 *	CFIntXMsgRqstSecGrpMembRdBy XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpMembObj> list = schemaObj.getSecGrpMembTableObj().readSecGrpMembByClusterIdx( natClusterId );
