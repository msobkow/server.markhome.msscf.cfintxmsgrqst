...
/*
 *	CFIntXMsgRqstISOCcyCreate XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyCreate" );
			...
			CFSecISOCcyBuff dataBuff = (CFSecISOCcyBuff)editBuff.getISOCcyBuff();
			// Extract Attributes
			...
			ICFIntISOCcyObj created = (ICFIntISOCcyObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCcyMessageFormatter.formatISOCcyRspnCreated( "\n\t\t\t", created.getISOCcyBuff() )
				+	"\n"
