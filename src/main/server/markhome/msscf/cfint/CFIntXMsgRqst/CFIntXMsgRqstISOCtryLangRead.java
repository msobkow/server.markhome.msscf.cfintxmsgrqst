...
/*
 *	CFIntXMsgRqstISOCtryLangRead XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecISOCtryLangPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactoryISOCtryLang().newPKey();
			...
			ICFIntISOCtryLangObj read = ((ICFIntISOCtryLangObj)schemaObj.getISOCtryLangTableObj().readISOCtryLang( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnSingleOpenTag()
					+	CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnDerivedRec( "\n\t\t", read.getISOCtryLangBuff() ) + "\n"
					+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnSingleCloseTag()
