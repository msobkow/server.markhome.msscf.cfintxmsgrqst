 ...
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectDelByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSubProjectDelByNameIdx" );
