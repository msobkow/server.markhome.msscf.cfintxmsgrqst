...
/*
 *	CFIntXMsgRqstMinorVersionUpdate XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntMinorVersionObj origBuff = ((ICFIntMinorVersionObj)schemaObj.getMinorVersionTableObj().readMinorVersion( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntMinorVersionEditObj editBuff = (ICFIntMinorVersionEditObj)origBuff.beginEdit();
				CFIntMinorVersionBuff dataBuff = editBuff.getMinorVersionBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnUpdated( "\n\t\t\t", origBuff.getMinorVersionBuff() )
					+	"\n"
