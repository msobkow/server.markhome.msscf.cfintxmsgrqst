...
/*
 *	CFIntXMsgRqstSysClusterCreate XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntSysClusterObj created = (ICFIntSysClusterObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnCreated( "\n\t\t\t", created.getSysClusterBuff() )
				+	"\n"
