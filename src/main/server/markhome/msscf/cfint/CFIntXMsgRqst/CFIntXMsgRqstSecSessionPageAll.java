...
// Description: Java 11 XML Message SAX Request Page All Element  for SecSession
...
/*
 *	CFIntXMsgRqstSecSessionPageAll XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionPageAll" );
			...
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().pageAllSecSession( natPriorSecSessionId );
