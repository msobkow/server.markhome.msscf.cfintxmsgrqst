...
/*
 *	CFIntXMsgRqstISOLangCreate XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangCreate" );
			...
			CFSecISOLangBuff dataBuff = (CFSecISOLangBuff)editBuff.getISOLangBuff();
			// Extract Attributes
			...
			ICFIntISOLangObj created = (ICFIntISOLangObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOLangMessageFormatter.formatISOLangRspnCreated( "\n\t\t\t", created.getISOLangBuff() )
				+	"\n"
