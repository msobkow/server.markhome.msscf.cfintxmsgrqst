...
/*
 *	CFIntXMsgRqstSecUserLock XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecUserId( natSecUserId );
			// Lock the object
			ICFIntSecUserObj locked = ((ICFIntSecUserObj)schemaObj.getSecUserTableObj().lockSecUser( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecUserMessageFormatter.formatSecUserRspnLocked( "\n\t\t\t", locked.getSecUserBuff() )
				+	"\n"
