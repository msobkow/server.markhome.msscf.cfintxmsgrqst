...
/*
 *	CFIntXMsgRqstMimeTypeUpdate XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRqstMimeTypeUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMimeTypeUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntMimeTypeObj origBuff = ((ICFIntMimeTypeObj)schemaObj.getMimeTypeTableObj().readMimeType( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntMimeTypeEditObj editBuff = (ICFIntMimeTypeEditObj)origBuff.beginEdit();
				CFIntMimeTypeBuff dataBuff = editBuff.getMimeTypeBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgMimeTypeMessageFormatter.formatMimeTypeRspnUpdated( "\n\t\t\t", origBuff.getMimeTypeBuff() )
					+	"\n"
