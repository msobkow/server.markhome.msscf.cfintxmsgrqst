...
/*
 *	CFIntXMsgRqstSecGrpIncCreate XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncCreate" );
			...
			CFSecSecGrpIncBuff dataBuff = (CFSecSecGrpIncBuff)editBuff.getSecGrpIncBuff();
			// Extract Attributes
			...
			ICFIntSecGrpIncObj created = (ICFIntSecGrpIncObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnCreated( "\n\t\t\t", created.getSecGrpIncBuff() )
				+	"\n"
