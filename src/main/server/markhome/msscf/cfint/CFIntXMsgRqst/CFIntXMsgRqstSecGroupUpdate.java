...
/*
 *	CFIntXMsgRqstSecGroupUpdate XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntSecGroupObj origBuff = ((ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroup( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntSecGroupEditObj editBuff = (ICFIntSecGroupEditObj)origBuff.beginEdit();
				CFSecSecGroupBuff dataBuff = editBuff.getSecGroupBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnUpdated( "\n\t\t\t", origBuff.getSecGroupBuff() )
					+	"\n"
