...
/*
 *	CFIntXMsgRqstSecGroupFormPageAll XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
