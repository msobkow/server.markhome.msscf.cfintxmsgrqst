...
/*
 *	CFIntXMsgRqstSecDeviceLock XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredDevName( natDevName );
			// Lock the object
			ICFIntSecDeviceObj locked = ((ICFIntSecDeviceObj)schemaObj.getSecDeviceTableObj().lockSecDevice( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRspnLocked( "\n\t\t\t", locked.getSecDeviceBuff() )
				+	"\n"
