 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRdByFinishIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRdByFinishIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionRdByFinishIdx" );
			...
			// Read the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().readSecSessionByFinishIdx( natSecUserId,
				natFinish );
