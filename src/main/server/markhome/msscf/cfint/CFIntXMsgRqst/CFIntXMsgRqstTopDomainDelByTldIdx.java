 ...
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainDelByTldIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainDelByTldIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTopDomainDelByTldIdx" );
