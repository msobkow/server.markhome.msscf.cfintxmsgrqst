...
/*
 *	CFIntXMsgRqstTopProjectUpdate XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRqstTopProjectUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopProjectUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntTopProjectObj origBuff = ((ICFIntTopProjectObj)schemaObj.getTopProjectTableObj().readTopProject( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntTopProjectEditObj editBuff = (ICFIntTopProjectEditObj)origBuff.beginEdit();
				CFIntTopProjectBuff dataBuff = editBuff.getTopProjectBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTopProjectMessageFormatter.formatTopProjectRspnUpdated( "\n\t\t\t", origBuff.getTopProjectBuff() )
					+	"\n"
