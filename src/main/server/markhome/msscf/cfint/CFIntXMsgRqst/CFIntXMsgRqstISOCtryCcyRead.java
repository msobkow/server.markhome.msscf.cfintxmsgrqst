...
/*
 *	CFIntXMsgRqstISOCtryCcyRead XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyRead" );
			...
			ICFIntISOCtryCcyObj read = ((ICFIntISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().readISOCtryCcy( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnSingleOpenTag()
					+	CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnDerivedRec( "\n\t\t", read.getISOCtryCcyBuff() ) + "\n"
					+	"\t" + CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnSingleCloseTag()
