...
/*
 *	CFIntXMsgRqstServiceTypeDelBy XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeDelByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeDelByUDescrIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceTypeDelByUDescrIdx" );
			...
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnDeleted() +	"\n"
