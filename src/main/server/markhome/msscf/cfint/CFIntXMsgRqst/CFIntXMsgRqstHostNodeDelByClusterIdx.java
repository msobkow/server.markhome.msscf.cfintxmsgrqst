 ...
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstHostNodeDelByClusterIdx" );
