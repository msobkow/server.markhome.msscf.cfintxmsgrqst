 ...
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionRdByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionRdByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionRdByNameIdx" );
			...
			// Read the object
			ICFIntMinorVersionObj read = ((ICFIntMinorVersionObj)schemaObj.getMinorVersionTableObj().readMinorVersionByNameIdx( natTenantId,
				natMajorVersionId,
				natName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnSingleOpenTag()
					+	CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnDerivedRec( "\n\t\t", read.getMinorVersionBuff() ) + "\n"
					+	"\t" + CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnSingleCloseTag()
