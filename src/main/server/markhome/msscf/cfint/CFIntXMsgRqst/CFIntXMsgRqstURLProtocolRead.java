...
/*
 *	CFIntXMsgRqstURLProtocolRead XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntURLProtocolObj read = ((ICFIntURLProtocolObj)schemaObj.getURLProtocolTableObj().readURLProtocol( pkey, true ));
			if( read != null ) {
