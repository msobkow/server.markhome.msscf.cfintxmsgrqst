...
/*
 *	CFIntXMsgRqstHostNodeRead XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntHostNodeObj read = ((ICFIntHostNodeObj)schemaObj.getHostNodeTableObj().readHostNode( pkey, true ));
			if( read != null ) {
