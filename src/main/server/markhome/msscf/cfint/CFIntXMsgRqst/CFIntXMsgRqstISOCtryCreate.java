...
/*
 *	CFIntXMsgRqstISOCtryCreate XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRqstISOCtryCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCreate" );
			...
			CFSecISOCtryBuff dataBuff = (CFSecISOCtryBuff)editBuff.getISOCtryBuff();
			// Extract Attributes
			...
			ICFIntISOCtryObj created = (ICFIntISOCtryObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryMessageFormatter.formatISOCtryRspnCreated( "\n\t\t\t", created.getISOCtryBuff() )
				+	"\n"
