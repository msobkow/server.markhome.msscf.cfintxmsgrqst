 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecServiceObj> list = schemaObj.getServiceTableObj().readServiceByClusterIdx( natClusterId );
