 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncDelByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncDelByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncDelByTenantIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpIncTableObj().deleteTSecGrpIncByTenantIdx( natTenantId );
