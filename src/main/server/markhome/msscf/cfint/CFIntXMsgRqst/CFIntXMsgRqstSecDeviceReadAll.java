...
// Description: Java 11 XML Message SAX Request Read All Element  for SecDevice
...
/*
 *	CFIntXMsgRqstSecDeviceReadAll XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecSecDeviceObj> list = schemaObj.getSecDeviceTableObj().readAllSecDevice( true );
