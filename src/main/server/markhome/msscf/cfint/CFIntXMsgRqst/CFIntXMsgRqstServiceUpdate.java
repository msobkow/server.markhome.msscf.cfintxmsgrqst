...
/*
 *	CFIntXMsgRqstServiceUpdate XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntServiceObj origBuff = ((ICFIntServiceObj)schemaObj.getServiceTableObj().readService( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntServiceEditObj editBuff = (ICFIntServiceEditObj)origBuff.beginEdit();
				CFSecServiceBuff dataBuff = editBuff.getServiceBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnUpdated( "\n\t\t\t", origBuff.getServiceBuff() )
					+	"\n"
