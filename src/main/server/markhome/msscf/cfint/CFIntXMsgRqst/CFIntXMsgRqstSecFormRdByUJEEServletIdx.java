 ...
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormRdByUJEEServletIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormRdByUJEEServletIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecFormRdByUJEEServletIdx" );
			...
			// Read the object
			ICFIntSecFormObj read = ((ICFIntSecFormObj)schemaObj.getSecFormTableObj().readSecFormByUJEEServletIdx( natClusterId,
				natSecAppId,
				natJEEServletMapName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnSingleOpenTag()
					+	CFIntXMsgSecFormMessageFormatter.formatSecFormRspnDerivedRec( "\n\t\t", read.getSecFormBuff() ) + "\n"
					+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnSingleCloseTag()
