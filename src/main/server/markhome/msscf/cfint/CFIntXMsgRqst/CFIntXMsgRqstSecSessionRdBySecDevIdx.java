 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionRdBySecDevIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionRdBySecDevIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionRdBySecDevIdx" );
			...
			// Read the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().readSecSessionBySecDevIdx( natSecUserId,
				natSecDevName );
