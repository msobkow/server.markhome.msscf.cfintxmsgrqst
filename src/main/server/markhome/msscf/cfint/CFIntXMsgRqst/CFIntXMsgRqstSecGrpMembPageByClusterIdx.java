...
/*
 *	CFIntXMsgRqstSecGrpMembPageBy XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembPageByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembPageByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembPageByClusterIdx" );
			...
			// Page the objects
			List<ICFSecSecGrpMembObj> list = schemaObj.getSecGrpMembTableObj().pageSecGrpMembByClusterIdx( natClusterId,
				natPriorClusterId,
