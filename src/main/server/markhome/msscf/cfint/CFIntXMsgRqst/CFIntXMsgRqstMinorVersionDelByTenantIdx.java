 ...
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionDelByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionDelByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionDelByTenantIdx" );
