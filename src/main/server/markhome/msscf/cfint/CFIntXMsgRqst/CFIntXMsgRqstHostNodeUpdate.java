...
/*
 *	CFIntXMsgRqstHostNodeUpdate XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntHostNodeObj origBuff = ((ICFIntHostNodeObj)schemaObj.getHostNodeTableObj().readHostNode( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntHostNodeEditObj editBuff = (ICFIntHostNodeEditObj)origBuff.beginEdit();
				CFSecHostNodeBuff dataBuff = editBuff.getHostNodeBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgHostNodeMessageFormatter.formatHostNodeRspnUpdated( "\n\t\t\t", origBuff.getHostNodeBuff() )
					+	"\n"
