 ...
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangDelByIdIdx" );
			...
			// Delete the objects
			schemaObj.getISOLangTableObj().deleteISOLangByIdIdx( natISOLangId );
