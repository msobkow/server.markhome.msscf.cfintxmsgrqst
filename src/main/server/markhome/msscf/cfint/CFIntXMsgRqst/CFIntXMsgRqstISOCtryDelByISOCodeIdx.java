...
// Description: Java 11 XML Message SAX Response Delete By Index Element  for ISOCtry
...
/*
 *	CFIntXMsgRqstISOCtryDelBy XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRqstISOCtryDelByISOCodeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryDelByISOCodeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryDelByISOCodeIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryTableObj().deleteISOCtryByISOCodeIdx( natISOCode );
