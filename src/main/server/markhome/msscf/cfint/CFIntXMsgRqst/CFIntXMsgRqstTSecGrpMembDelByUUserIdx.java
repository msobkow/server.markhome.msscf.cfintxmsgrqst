 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembDelByUUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembDelByUUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembDelByUUserIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpMembTableObj().deleteTSecGrpMembByUUserIdx( natTenantId,
				natTSecGroupId,
				natSecUserId );
