 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncRdByIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncRdByIncludeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncRdByIncludeIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpIncObj> list = schemaObj.getSecGrpIncTableObj().readSecGrpIncByIncludeIdx( natClusterId,
				natIncludeGroupId );
