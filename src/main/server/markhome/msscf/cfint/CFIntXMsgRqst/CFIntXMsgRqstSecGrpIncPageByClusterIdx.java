...
/*
 *	CFIntXMsgRqstSecGrpIncPageBy XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncPageByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncPageByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncPageByClusterIdx" );
			...
			// Page the objects
			List<ICFSecSecGrpIncObj> list = schemaObj.getSecGrpIncTableObj().pageSecGrpIncByClusterIdx( natClusterId,
				natPriorClusterId,
				natPriorSecGrpIncId );
