 ...
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecDeviceDelByIdIdx" );
