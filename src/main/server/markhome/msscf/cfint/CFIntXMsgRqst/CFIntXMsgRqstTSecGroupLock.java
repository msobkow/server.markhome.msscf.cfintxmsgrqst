...
/*
 *	CFIntXMsgRqstTSecGroupLock XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredTSecGroupId( natTSecGroupId );
			// Lock the object
			ICFIntTSecGroupObj locked = ((ICFIntTSecGroupObj)schemaObj.getTSecGroupTableObj().lockTSecGroup( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTSecGroupMessageFormatter.formatTSecGroupRspnLocked( "\n\t\t\t", locked.getTSecGroupBuff() )
				+	"\n"
