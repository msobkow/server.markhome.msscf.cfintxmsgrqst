 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembRdByUUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembRdByUUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembRdByUUserIdx" );
			...
			// Read the object
			ICFIntSecGrpMembObj read = ((ICFIntSecGrpMembObj)schemaObj.getSecGrpMembTableObj().readSecGrpMembByUUserIdx( natClusterId,
				natSecGroupId,
				natSecUserId,
				true ));
			if( read != null ) {
