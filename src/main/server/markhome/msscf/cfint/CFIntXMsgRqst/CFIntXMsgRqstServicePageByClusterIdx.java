...
/*
 *	CFIntXMsgRqstServicePageBy XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServicePageByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServicePageByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServicePageByClusterIdx" );
			...
			// Page the objects
			List<ICFSecServiceObj> list = schemaObj.getServiceTableObj().pageServiceByClusterIdx( natClusterId,
				natPriorClusterId,
				natPriorServiceId );
