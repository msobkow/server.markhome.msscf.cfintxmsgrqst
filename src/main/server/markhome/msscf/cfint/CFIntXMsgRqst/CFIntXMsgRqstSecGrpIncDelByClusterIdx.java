 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncDelByClusterIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpIncTableObj().deleteSecGrpIncByClusterIdx( natClusterId );
