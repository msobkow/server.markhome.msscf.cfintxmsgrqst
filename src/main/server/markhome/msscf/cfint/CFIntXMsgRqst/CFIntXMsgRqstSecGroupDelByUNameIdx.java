 ...
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupDelByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupDelByUNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupDelByUNameIdx" );
