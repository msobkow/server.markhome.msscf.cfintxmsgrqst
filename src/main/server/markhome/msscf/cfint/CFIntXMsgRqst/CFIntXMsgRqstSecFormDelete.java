...
/*
 *	CFIntXMsgRqstSecFormDelete XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSecFormObj read = ((ICFIntSecFormObj)schemaObj.getSecFormTableObj().readSecForm( pkey ));
			if( read != null ) {
				if( read.getSecFormBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSecFormEditObj editBuff = (ICFIntSecFormEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnDeleted() +	"\n"
