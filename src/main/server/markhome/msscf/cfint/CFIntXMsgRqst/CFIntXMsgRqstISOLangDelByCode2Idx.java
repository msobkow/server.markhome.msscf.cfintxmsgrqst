 ...
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangDelByCode2Idx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangDelByCode2Idx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangDelByCode2Idx" );
			...
			// Delete the objects
			schemaObj.getISOLangTableObj().deleteISOLangByCode2Idx( natISO6391Code );
