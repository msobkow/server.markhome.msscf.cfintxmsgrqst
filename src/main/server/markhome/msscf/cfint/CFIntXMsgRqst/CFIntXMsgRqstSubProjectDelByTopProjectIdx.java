...
/*
 *	CFIntXMsgRqstSubProjectDelBy XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectDelByTopProjectIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectDelByTopProjectIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSubProjectDelByTopProjectIdx" );
			...
			// Delete the objects
			schemaObj.getSubProjectTableObj().deleteSubProjectByTopProjectIdx( natTenantId,
				natTopProjectId );
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSubProjectMessageFormatter.formatSubProjectRspnDeleted() +	"\n"
