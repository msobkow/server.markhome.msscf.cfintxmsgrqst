...
/*
 *	CFIntXMsgRqstMimeTypeCreate XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRqstMimeTypeCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMimeTypeCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntMimeTypeBuff dataBuff = (CFIntMimeTypeBuff)editBuff.getMimeTypeBuff();
			// Extract Attributes
			...
			ICFIntMimeTypeObj created = (ICFIntMimeTypeObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgMimeTypeMessageFormatter.formatMimeTypeRspnCreated( "\n\t\t\t", created.getMimeTypeBuff() )
				+	"\n"
