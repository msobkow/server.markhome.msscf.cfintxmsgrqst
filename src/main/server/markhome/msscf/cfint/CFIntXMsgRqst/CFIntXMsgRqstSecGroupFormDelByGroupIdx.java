 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormDelByGroupIdx" );
