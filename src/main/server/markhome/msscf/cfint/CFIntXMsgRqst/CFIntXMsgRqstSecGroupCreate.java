...
/*
 *	CFIntXMsgRqstSecGroupCreate XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecGroupBuff dataBuff = (CFSecSecGroupBuff)editBuff.getSecGroupBuff();
			// Extract Attributes
			...
			ICFIntSecGroupObj created = (ICFIntSecGroupObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGroupMessageFormatter.formatSecGroupRspnCreated( "\n\t\t\t", created.getSecGroupBuff() )
				+	"\n"
