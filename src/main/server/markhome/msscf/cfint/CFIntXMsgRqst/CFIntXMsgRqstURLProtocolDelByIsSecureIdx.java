...
/*
 *	CFIntXMsgRqstURLProtocolDelBy XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolDelByIsSecureIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolDelByIsSecureIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstURLProtocolDelByIsSecureIdx" );
