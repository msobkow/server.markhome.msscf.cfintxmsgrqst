...
/*
 *	CFIntXMsgRqstSecGrpIncPageAll XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
