...
/*
 *	CFIntXMsgRqstISOLangLock XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangLock" );
			...
			pkey.setRequiredISOLangId( natISOLangId );
			// Lock the object
			ICFIntISOLangObj locked = ((ICFIntISOLangObj)schemaObj.getISOLangTableObj().lockISOLang( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOLangMessageFormatter.formatISOLangRspnLocked( "\n\t\t\t", locked.getISOLangBuff() )
				+	"\n"
