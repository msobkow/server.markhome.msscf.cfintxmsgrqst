...
/*
 *	CFIntXMsgRqstSecGroupFormLock XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecGroupFormId( natSecGroupFormId );
			// Lock the object
			ICFIntSecGroupFormObj locked = ((ICFIntSecGroupFormObj)schemaObj.getSecGroupFormTableObj().lockSecGroupForm( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnLocked( "\n\t\t\t", locked.getSecGroupFormBuff() )
				+	"\n"
