...
/*
 *	CFIntXMsgRqstTSecGrpIncPageAll XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
