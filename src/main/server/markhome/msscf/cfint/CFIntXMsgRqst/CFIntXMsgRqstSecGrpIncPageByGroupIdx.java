 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncPageByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncPageByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncPageByGroupIdx" );
			...
			// Page the objects
			List<ICFSecSecGrpIncObj> list = schemaObj.getSecGrpIncTableObj().pageSecGrpIncByGroupIdx( natClusterId,
				natSecGroupId,
				natPriorClusterId,
				natPriorSecGrpIncId );
