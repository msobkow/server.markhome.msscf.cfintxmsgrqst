 ...
 *	for ISOLang.
 */
public class CFIntXMsgRqstISOLangRdByCode3Idx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOLangRdByCode3Idx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOLangRdByCode3Idx" );
			...
			// Read the object
			ICFIntISOLangObj read = ((ICFIntISOLangObj)schemaObj.getISOLangTableObj().readISOLangByCode3Idx( natISO6392Code,
				true ));
			if( read != null ) {
