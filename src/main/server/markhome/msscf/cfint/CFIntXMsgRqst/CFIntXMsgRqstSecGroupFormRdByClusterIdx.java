 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().readSecGroupFormByClusterIdx( natClusterId );
