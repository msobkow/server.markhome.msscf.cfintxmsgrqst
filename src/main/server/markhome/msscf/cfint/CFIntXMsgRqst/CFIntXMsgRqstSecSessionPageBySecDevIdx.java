 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionPageBySecDevIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionPageBySecDevIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionPageBySecDevIdx" );
			...
			// Page the objects
			List<ICFSecSecSessionObj> list = schemaObj.getSecSessionTableObj().pageSecSessionBySecDevIdx( natSecUserId,
				natSecDevName,
