 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembDelByClusterIdx" );
			...
			// Delete the objects
			schemaObj.getSecGrpMembTableObj().deleteSecGrpMembByClusterIdx( natClusterId );
