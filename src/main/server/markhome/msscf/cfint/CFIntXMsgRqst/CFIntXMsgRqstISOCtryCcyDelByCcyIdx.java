 ...
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyDelByCcyIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyDelByCcyIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyDelByCcyIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryCcyTableObj().deleteISOCtryCcyByCcyIdx( natISOCcyId );
