 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembRdByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembRdByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembRdByUserIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpMembObj> list = schemaObj.getTSecGrpMembTableObj().readTSecGrpMembByUserIdx( natSecUserId );
