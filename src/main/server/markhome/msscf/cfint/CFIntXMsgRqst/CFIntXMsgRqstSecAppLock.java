...
/*
 *	CFIntXMsgRqstSecAppLock XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecAppId( natSecAppId );
			// Lock the object
			ICFIntSecAppObj locked = ((ICFIntSecAppObj)schemaObj.getSecAppTableObj().lockSecApp( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecAppMessageFormatter.formatSecAppRspnLocked( "\n\t\t\t", locked.getSecAppBuff() )
				+	"\n"
