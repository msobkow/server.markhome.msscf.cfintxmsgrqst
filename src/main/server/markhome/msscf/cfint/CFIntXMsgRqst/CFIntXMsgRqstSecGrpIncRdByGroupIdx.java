 ...
 *	for SecGrpInc.
 */
public class CFIntXMsgRqstSecGrpIncRdByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpIncRdByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpIncRdByGroupIdx" );
			...
			// Read the objects
			List<ICFSecSecGrpIncObj> list = schemaObj.getSecGrpIncTableObj().readSecGrpIncByGroupIdx( natClusterId,
				natSecGroupId );
