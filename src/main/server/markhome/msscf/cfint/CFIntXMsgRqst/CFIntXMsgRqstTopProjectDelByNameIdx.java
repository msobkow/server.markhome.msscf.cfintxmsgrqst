 ...
 *	for TopProject.
 */
public class CFIntXMsgRqstTopProjectDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopProjectDelByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTopProjectDelByNameIdx" );
