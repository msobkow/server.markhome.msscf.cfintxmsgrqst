 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembRdByUUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembRdByUUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFIntTSecGrpMembObj read = ((ICFIntTSecGrpMembObj)schemaObj.getTSecGrpMembTableObj().readTSecGrpMembByUUserIdx( natTenantId,
				natTSecGroupId,
				natSecUserId,
				true ));
			if( read != null ) {
