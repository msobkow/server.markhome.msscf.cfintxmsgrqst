 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormPageByFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormPageByFormIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormPageByFormIdx" );
			...
			// Page the objects
			List<ICFSecSecGroupFormObj> list = schemaObj.getSecGroupFormTableObj().pageSecGroupFormByFormIdx( natClusterId,
				natSecFormId,
				natPriorClusterId,
