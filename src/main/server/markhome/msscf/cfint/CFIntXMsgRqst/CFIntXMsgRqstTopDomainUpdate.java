...
/*
 *	CFIntXMsgRqstTopDomainUpdate XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntTopDomainObj origBuff = ((ICFIntTopDomainObj)schemaObj.getTopDomainTableObj().readTopDomain( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntTopDomainEditObj editBuff = (ICFIntTopDomainEditObj)origBuff.beginEdit();
				CFIntTopDomainBuff dataBuff = editBuff.getTopDomainBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTopDomainMessageFormatter.formatTopDomainRspnUpdated( "\n\t\t\t", origBuff.getTopDomainBuff() )
					+	"\n"
