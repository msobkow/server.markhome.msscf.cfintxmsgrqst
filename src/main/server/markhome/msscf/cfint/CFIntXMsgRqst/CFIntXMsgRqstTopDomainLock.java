...
/*
 *	CFIntXMsgRqstTopDomainLock XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntTopDomainObj locked = ((ICFIntTopDomainObj)schemaObj.getTopDomainTableObj().lockTopDomain( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTopDomainMessageFormatter.formatTopDomainRspnLocked( "\n\t\t\t", locked.getTopDomainBuff() )
				+	"\n"
