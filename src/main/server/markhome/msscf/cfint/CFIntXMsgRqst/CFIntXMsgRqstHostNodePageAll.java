...
/*
 *	CFIntXMsgRqstHostNodePageAll XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodePageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodePageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
