...
/*
 *	CFIntXMsgRqstMinorVersionCreate XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntMinorVersionBuff dataBuff = (CFIntMinorVersionBuff)editBuff.getMinorVersionBuff();
			// Extract Attributes
			...
			ICFIntMinorVersionObj created = (ICFIntMinorVersionObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgMinorVersionMessageFormatter.formatMinorVersionRspnCreated( "\n\t\t\t", created.getMinorVersionBuff() )
				+	"\n"
