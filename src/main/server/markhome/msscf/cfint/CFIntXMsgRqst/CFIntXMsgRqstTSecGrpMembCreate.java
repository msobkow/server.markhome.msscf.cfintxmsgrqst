...
/*
 *	CFIntXMsgRqstTSecGrpMembCreate XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembCreate" );
			...
			CFSecTSecGrpMembBuff dataBuff = (CFSecTSecGrpMembBuff)editBuff.getTSecGrpMembBuff();
			// Extract Attributes
			...
			ICFIntTSecGrpMembObj created = (ICFIntTSecGrpMembObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRspnCreated( "\n\t\t\t", created.getTSecGrpMembBuff() )
				+	"\n"
