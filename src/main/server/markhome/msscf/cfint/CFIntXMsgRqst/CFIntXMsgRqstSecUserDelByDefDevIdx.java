 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserDelByDefDevIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserDelByDefDevIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserDelByDefDevIdx" );
			...
			// Delete the objects
			schemaObj.getSecUserTableObj().deleteSecUserByDefDevIdx( natDfltDevUserId,
				natDfltDevName );
