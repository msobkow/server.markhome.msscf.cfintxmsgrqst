 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembPageByUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembPageByUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembPageByUserIdx" );
			...
			// Page the objects
			List<ICFSecTSecGrpMembObj> list = schemaObj.getTSecGrpMembTableObj().pageTSecGrpMembByUserIdx( natSecUserId,
				natPriorTenantId,
