...
/*
 *	CFIntXMsgRqstServiceTypeRead XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecServiceTypePKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactoryServiceType().newPKey();
			...
			ICFIntServiceTypeObj read = ((ICFIntServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceType( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnSingleOpenTag()
					+	CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnDerivedRec( "\n\t\t", read.getServiceTypeBuff() ) + "\n"
					+	"\t" + CFIntXMsgServiceTypeMessageFormatter.formatServiceTypeRspnSingleCloseTag()
