 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionDelByIdIdx" );
