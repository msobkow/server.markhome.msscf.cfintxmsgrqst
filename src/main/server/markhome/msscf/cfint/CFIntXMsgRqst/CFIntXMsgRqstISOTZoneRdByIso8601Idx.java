 ...
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneRdByIso8601Idx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneRdByIso8601Idx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneRdByIso8601Idx" );
			...
			// Read the objects
			List<ICFSecISOTZoneObj> list = schemaObj.getISOTZoneTableObj().readISOTZoneByIso8601Idx( natIso8601 );
