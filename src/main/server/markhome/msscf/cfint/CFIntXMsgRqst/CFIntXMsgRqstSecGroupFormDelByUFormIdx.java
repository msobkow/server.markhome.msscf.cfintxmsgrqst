 ...
 *	for SecGroupForm.
 */
public class CFIntXMsgRqstSecGroupFormDelByUFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupFormDelByUFormIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupFormDelByUFormIdx" );
