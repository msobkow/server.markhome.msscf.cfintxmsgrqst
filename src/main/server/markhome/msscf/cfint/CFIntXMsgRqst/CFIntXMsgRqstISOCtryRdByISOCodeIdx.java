...
/*
 *	CFIntXMsgRqstISOCtryRdBy XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRqstISOCtryRdByISOCodeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryRdByISOCodeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryRdByISOCodeIdx" );
			...
			// Read the object
			ICFIntISOCtryObj read = ((ICFIntISOCtryObj)schemaObj.getISOCtryTableObj().readISOCtryByISOCodeIdx( natISOCode,
				true ));
			if( read != null ) {
