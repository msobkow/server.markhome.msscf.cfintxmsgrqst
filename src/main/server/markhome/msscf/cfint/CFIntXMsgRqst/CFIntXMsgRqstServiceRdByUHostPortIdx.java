...
/*
 *	CFIntXMsgRqstServiceRdBy XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRqstServiceRdByUHostPortIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceRdByUHostPortIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceRdByUHostPortIdx" );
			...
			// Read the object
			ICFIntServiceObj read = ((ICFIntServiceObj)schemaObj.getServiceTableObj().readServiceByUHostPortIdx( natClusterId,
				natHostNodeId,
				natHostPort,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnSingleOpenTag()
					+	CFIntXMsgServiceMessageFormatter.formatServiceRspnDerivedRec( "\n\t\t", read.getServiceBuff() ) + "\n"
					+	"\t" + CFIntXMsgServiceMessageFormatter.formatServiceRspnSingleCloseTag()
