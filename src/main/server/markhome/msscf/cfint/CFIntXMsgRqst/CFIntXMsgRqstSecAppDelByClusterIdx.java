 ...
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecAppDelByClusterIdx" );
