...
/*
 *	CFIntXMsgRqstISOCcyRdBy XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRqstISOCcyRdByCcyCdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCcyRdByCcyCdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCcyRdByCcyCdIdx" );
			...
			// Read the object
			ICFIntISOCcyObj read = ((ICFIntISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcyByCcyCdIdx( natISOCode,
				true ));
			if( read != null ) {
