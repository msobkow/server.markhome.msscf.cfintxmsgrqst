...
/*
 *	CFIntXMsgRqstTenantCreate XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRqstTenantCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTenantCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntTenantEditObj editBuff = (ICFIntTenantEditObj)schemaObj.getTenantTableObj().newInstance().beginEdit();
			CFSecTenantBuff dataBuff = (CFSecTenantBuff)editBuff.getTenantBuff();
			// Extract Attributes
			...
			ICFIntTenantObj created = (ICFIntTenantObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTenantMessageFormatter.formatTenantRspnCreated( "\n\t\t\t", created.getTenantBuff() )
				+	"\n"
