...
/*
 *	CFIntXMsgRqstTldUpdate XML SAX Element  implementation
 *	for Tld.
 */
public class CFIntXMsgRqstTldUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTldUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntTldObj origBuff = ((ICFIntTldObj)schemaObj.getTldTableObj().readTld( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntTldEditObj editBuff = (ICFIntTldEditObj)origBuff.beginEdit();
				CFIntTldBuff dataBuff = editBuff.getTldBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTldMessageFormatter.formatTldRspnUpdated( "\n\t\t\t", origBuff.getTldBuff() )
					+	"\n"
