 ...
 *	for ServiceType.
 */
public class CFIntXMsgRqstServiceTypeDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceTypeDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceTypeDelByIdIdx" );
