...
/*
 *	CFIntXMsgRqstSysClusterRead XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSysClusterPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactorySysCluster().newPKey();
			...
			ICFIntSysClusterObj read = ((ICFIntSysClusterObj)schemaObj.getSysClusterTableObj().readSysCluster( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnSingleOpenTag()
					+	CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnDerivedRec( "\n\t\t", read.getSysClusterBuff() ) + "\n"
					+	"\t" + CFIntXMsgSysClusterMessageFormatter.formatSysClusterRspnSingleCloseTag()
