...
/*
 *	CFIntXMsgRqstISOCtryCcyDelBy XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyDelByCtryIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyDelByCtryIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyDelByCtryIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryCcyTableObj().deleteISOCtryCcyByCtryIdx( natISOCtryId );
