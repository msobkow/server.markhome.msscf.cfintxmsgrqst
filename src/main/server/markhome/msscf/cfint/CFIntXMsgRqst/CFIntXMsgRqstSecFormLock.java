...
/*
 *	CFIntXMsgRqstSecFormLock XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRqstSecFormLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecFormLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecFormId( natSecFormId );
			// Lock the object
			ICFIntSecFormObj locked = ((ICFIntSecFormObj)schemaObj.getSecFormTableObj().lockSecForm( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecFormMessageFormatter.formatSecFormRspnLocked( "\n\t\t\t", locked.getSecFormBuff() )
				+	"\n"
