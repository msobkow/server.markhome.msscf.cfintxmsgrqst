...
/*
 *	CFIntXMsgRqstSecDeviceCreate XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRqstSecDeviceCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecDeviceCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecDeviceBuff dataBuff = (CFSecSecDeviceBuff)editBuff.getSecDeviceBuff();
			// Extract Attributes
			...
			ICFIntSecDeviceObj created = (ICFIntSecDeviceObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRspnCreated( "\n\t\t\t", created.getSecDeviceBuff() )
				+	"\n"
