...
/*
 *	CFIntXMsgRqstSecGroupRead XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecGroupPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactorySecGroup().newPKey();
			...
			ICFIntSecGroupObj read = ((ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroup( pkey, true ));
			if( read != null ) {
