 ...
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecAppRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecAppObj> list = schemaObj.getSecAppTableObj().readSecAppByClusterIdx( natClusterId );
