 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelBySecDevIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelBySecDevIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionDelBySecDevIdx" );
