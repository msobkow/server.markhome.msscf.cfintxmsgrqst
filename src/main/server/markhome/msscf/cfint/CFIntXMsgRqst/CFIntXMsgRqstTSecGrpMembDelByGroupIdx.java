 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembDelByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembDelByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembDelByGroupIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpMembTableObj().deleteTSecGrpMembByGroupIdx( natTenantId,
				natTSecGroupId );
