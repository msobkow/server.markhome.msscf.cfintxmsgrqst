...
/*
 *	CFIntXMsgRqstTSecGroupDelete XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntTSecGroupObj read = ((ICFIntTSecGroupObj)schemaObj.getTSecGroupTableObj().readTSecGroup( pkey ));
			if( read != null ) {
				if( read.getTSecGroupBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntTSecGroupEditObj editBuff = (ICFIntTSecGroupEditObj)read.beginEdit();
					if( editBuff != null ) {
