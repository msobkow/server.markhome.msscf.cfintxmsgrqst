 ...
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRqstTSecGrpMembDelByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpMembDelByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpMembDelByTenantIdx" );
			...
			// Delete the objects
			schemaObj.getTSecGrpMembTableObj().deleteTSecGrpMembByTenantIdx( natTenantId );
