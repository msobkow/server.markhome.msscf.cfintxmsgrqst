 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncRdByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncRdByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncRdByGroupIdx" );
			...
			// Read the objects
			List<ICFSecTSecGrpIncObj> list = schemaObj.getTSecGrpIncTableObj().readTSecGrpIncByGroupIdx( natTenantId,
				natTSecGroupId );
