...
/*
 *	CFIntXMsgRqstISOCtryLock XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRqstISOCtryLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryLock" );
			...
			pkey.setRequiredISOCtryId( natISOCtryId );
			// Lock the object
			ICFIntISOCtryObj locked = ((ICFIntISOCtryObj)schemaObj.getISOCtryTableObj().lockISOCtry( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryMessageFormatter.formatISOCtryRspnLocked( "\n\t\t\t", locked.getISOCtryBuff() )
				+	"\n"
