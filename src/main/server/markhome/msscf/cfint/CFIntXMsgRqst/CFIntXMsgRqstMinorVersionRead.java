...
/*
 *	CFIntXMsgRqstMinorVersionRead XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntMinorVersionObj read = ((ICFIntMinorVersionObj)schemaObj.getMinorVersionTableObj().readMinorVersion( pkey, true ));
			if( read != null ) {
