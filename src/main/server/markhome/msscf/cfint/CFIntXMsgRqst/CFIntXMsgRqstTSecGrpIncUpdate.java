...
/*
 *	CFIntXMsgRqstTSecGrpIncUpdate XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncUpdate" );
			...
			// Read the instance
			ICFIntTSecGrpIncObj origBuff = ((ICFIntTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().readTSecGrpInc( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
					"getTSecGrpIncTableObj().readTSecGrpInc()" );
			}
			else {
				// Edit the instance
				ICFIntTSecGrpIncEditObj editBuff = (ICFIntTSecGrpIncEditObj)origBuff.beginEdit();
				CFSecTSecGrpIncBuff dataBuff = editBuff.getTSecGrpIncBuff();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRspnUpdated( "\n\t\t\t", origBuff.getTSecGrpIncBuff() )
					+	"\n"
