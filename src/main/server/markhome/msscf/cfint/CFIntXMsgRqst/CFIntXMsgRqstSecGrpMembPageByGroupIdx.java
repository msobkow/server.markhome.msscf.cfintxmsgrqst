 ...
 *	for SecGrpMemb.
 */
public class CFIntXMsgRqstSecGrpMembPageByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGrpMembPageByGroupIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGrpMembPageByGroupIdx" );
			...
			// Page the objects
			List<ICFSecSecGrpMembObj> list = schemaObj.getSecGrpMembTableObj().pageSecGrpMembByGroupIdx( natClusterId,
				natSecGroupId,
				natPriorClusterId,
