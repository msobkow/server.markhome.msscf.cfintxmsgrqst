 ...
 *	for MinorVersion.
 */
public class CFIntXMsgRqstMinorVersionRdByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstMinorVersionRdByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstMinorVersionRdByTenantIdx" );
			...
			// Read the objects
			List<ICFIntMinorVersionObj> list = schemaObj.getMinorVersionTableObj().readMinorVersionByTenantIdx( natTenantId );
