 ...
 *	for URLProtocol.
 */
public class CFIntXMsgRqstURLProtocolDelByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstURLProtocolDelByUNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstURLProtocolDelByUNameIdx" );
