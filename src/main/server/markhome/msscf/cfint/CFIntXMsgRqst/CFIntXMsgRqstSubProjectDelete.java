...
/*
 *	CFIntXMsgRqstSubProjectDelete XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRqstSubProjectDelete
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSubProjectDelete( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFIntSubProjectObj read = ((ICFIntSubProjectObj)schemaObj.getSubProjectTableObj().readSubProject( pkey ));
			if( read != null ) {
				if( read.getSubProjectBuff().getRequiredRevision() > natRevision ) {
					...
					ICFIntSubProjectEditObj editBuff = (ICFIntSubProjectEditObj)read.beginEdit();
					if( editBuff != null ) {
