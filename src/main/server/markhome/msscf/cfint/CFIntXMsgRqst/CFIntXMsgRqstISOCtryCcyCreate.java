...
/*
 *	CFIntXMsgRqstISOCtryCcyCreate XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRqstISOCtryCcyCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryCcyCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryCcyCreate" );
			...
			CFSecISOCtryCcyBuff dataBuff = (CFSecISOCtryCcyBuff)editBuff.getISOCtryCcyBuff();
			// Extract Attributes
			...
			ICFIntISOCtryCcyObj created = (ICFIntISOCtryCcyObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnCreated( "\n\t\t\t", created.getISOCtryCcyBuff() )
				+	"\n"
