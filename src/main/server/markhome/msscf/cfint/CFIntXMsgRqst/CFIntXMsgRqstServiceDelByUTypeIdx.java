 ...
 *	for Service.
 */
public class CFIntXMsgRqstServiceDelByUTypeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstServiceDelByUTypeIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstServiceDelByUTypeIdx" );
