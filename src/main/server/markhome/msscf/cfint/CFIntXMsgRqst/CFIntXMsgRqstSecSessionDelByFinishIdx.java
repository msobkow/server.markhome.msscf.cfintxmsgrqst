 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelByFinishIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelByFinishIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionDelByFinishIdx" );
