 ...
 *	for TSecGroup.
 */
public class CFIntXMsgRqstTSecGroupDelByIdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGroupDelByIdIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGroupDelByIdIdx" );
