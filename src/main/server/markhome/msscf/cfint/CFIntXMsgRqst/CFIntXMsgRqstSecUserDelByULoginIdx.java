 ...
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserDelByULoginIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserDelByULoginIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserDelByULoginIdx" );
