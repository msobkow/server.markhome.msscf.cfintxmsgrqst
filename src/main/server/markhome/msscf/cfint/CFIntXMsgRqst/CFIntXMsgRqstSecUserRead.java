...
/*
 *	CFIntXMsgRqstSecUserRead XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecUserPKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactorySecUser().newPKey();
			...
			ICFIntSecUserObj read = ((ICFIntSecUserObj)schemaObj.getSecUserTableObj().readSecUser( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgSecUserMessageFormatter.formatSecUserRspnSingleOpenTag()
					+	CFIntXMsgSecUserMessageFormatter.formatSecUserRspnDerivedRec( "\n\t\t", read.getSecUserBuff() ) + "\n"
					+	"\t" + CFIntXMsgSecUserMessageFormatter.formatSecUserRspnSingleCloseTag()
