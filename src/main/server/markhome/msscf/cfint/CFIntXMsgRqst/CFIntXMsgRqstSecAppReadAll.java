...
// Description: Java 11 XML Message SAX Request Read All Element  for SecApp
...
/*
 *	CFIntXMsgRqstSecAppReadAll XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppReadAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			List<ICFSecSecAppObj> list = schemaObj.getSecAppTableObj().readAllSecApp( true );
