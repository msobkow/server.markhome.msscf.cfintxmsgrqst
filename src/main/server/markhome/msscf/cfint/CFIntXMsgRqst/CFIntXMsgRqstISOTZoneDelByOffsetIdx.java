 ...
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneDelByOffsetIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneDelByOffsetIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneDelByOffsetIdx" );
			...
			// Delete the objects
			schemaObj.getISOTZoneTableObj().deleteISOTZoneByOffsetIdx( natTZHourOffset,
				natTZMinOffset );
