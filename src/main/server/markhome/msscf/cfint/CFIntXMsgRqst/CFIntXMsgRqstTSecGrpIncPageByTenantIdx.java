 ...
 *	for TSecGrpInc.
 */
public class CFIntXMsgRqstTSecGrpIncPageByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTSecGrpIncPageByTenantIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTSecGrpIncPageByTenantIdx" );
			...
			// Page the objects
			List<ICFSecTSecGrpIncObj> list = schemaObj.getTSecGrpIncTableObj().pageTSecGrpIncByTenantIdx( natTenantId,
				natPriorTenantId,
