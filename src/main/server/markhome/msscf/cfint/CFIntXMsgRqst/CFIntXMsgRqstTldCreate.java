...
/*
 *	CFIntXMsgRqstTldCreate XML SAX Element  implementation
 *	for Tld.
 */
public class CFIntXMsgRqstTldCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTldCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntTldBuff dataBuff = (CFIntTldBuff)editBuff.getTldBuff();
			// Extract Attributes
			...
			ICFIntTldObj created = (ICFIntTldObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgTldMessageFormatter.formatTldRspnCreated( "\n\t\t\t", created.getTldBuff() )
				+	"\n"
