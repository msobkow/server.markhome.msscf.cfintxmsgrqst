...
/*
 *	CFIntXMsgRqstSysClusterDelBy XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRqstSysClusterDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSysClusterDelByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSysClusterDelByClusterIdx" );
