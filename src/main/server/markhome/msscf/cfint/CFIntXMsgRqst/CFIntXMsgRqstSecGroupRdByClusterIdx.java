 ...
 *	for SecGroup.
 */
public class CFIntXMsgRqstSecGroupRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecGroupRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecGroupRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecSecGroupObj> list = schemaObj.getSecGroupTableObj().readSecGroupByClusterIdx( natClusterId );
