...
/*
 *	CFIntXMsgRqstSecUserDelBy XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserDelByEMConfIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserDelByEMConfIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserDelByEMConfIdx" );
			...
			// Delete the objects
			schemaObj.getSecUserTableObj().deleteSecUserByEMConfIdx( natEMailConfirmUuid );
