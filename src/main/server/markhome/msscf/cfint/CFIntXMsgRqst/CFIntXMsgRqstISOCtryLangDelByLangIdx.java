...
/*
 *	CFIntXMsgRqstISOCtryLangDelBy XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRqstISOCtryLangDelByLangIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOCtryLangDelByLangIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOCtryLangDelByLangIdx" );
			...
			// Delete the objects
			schemaObj.getISOCtryLangTableObj().deleteISOCtryLangByLangIdx( natISOLangId );
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnDeleted() +	"\n"
