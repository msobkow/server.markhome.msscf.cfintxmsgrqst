...
/*
 *	CFIntXMsgRqstSecAppPageAll XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRqstSecAppPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecAppPageAll( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
