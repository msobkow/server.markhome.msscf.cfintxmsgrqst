 ...
 *	for HostNode.
 */
public class CFIntXMsgRqstHostNodeRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstHostNodeRdByClusterIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstHostNodeRdByClusterIdx" );
			...
			// Read the objects
			List<ICFSecHostNodeObj> list = schemaObj.getHostNodeTableObj().readHostNodeByClusterIdx( natClusterId );
