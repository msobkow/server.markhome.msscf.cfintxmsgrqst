 ...
 *	for TopDomain.
 */
public class CFIntXMsgRqstTopDomainDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstTopDomainDelByNameIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstTopDomainDelByNameIdx" );
