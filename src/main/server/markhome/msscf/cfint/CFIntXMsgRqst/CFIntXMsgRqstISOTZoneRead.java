...
/*
 *	CFIntXMsgRqstISOTZoneRead XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRqstISOTZoneRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstISOTZoneRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstISOTZoneRead" );
			...
			ICFIntISOTZoneObj read = ((ICFIntISOTZoneObj)schemaObj.getISOTZoneTableObj().readISOTZone( pkey, true ));
			if( read != null ) {
