 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelBySecUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelBySecUserIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionDelBySecUserIdx" );
