 ...
 *	for SecSession.
 */
public class CFIntXMsgRqstSecSessionDelByStartIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecSessionDelByStartIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecSessionDelByStartIdx" );
