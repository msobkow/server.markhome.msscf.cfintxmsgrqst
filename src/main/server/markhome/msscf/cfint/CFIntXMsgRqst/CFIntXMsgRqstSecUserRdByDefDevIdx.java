...
/*
 *	CFIntXMsgRqstSecUserRdBy XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRqstSecUserRdByDefDevIdx
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstSecUserRdByDefDevIdx( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			assert qName.equals( "RqstSecUserRdByDefDevIdx" );
			...
			// Read the objects
			List<ICFSecSecUserObj> list = schemaObj.getSecUserTableObj().readSecUserByDefDevIdx( natDfltDevUserId,
				natDfltDevName );
